...
//
// $Id: MenuItem.cs,v 1.10 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class MenuItem : Object {
      ...
      public Menu Menu {
         get {
            return (Menu)FindObject(wxMenuItem_GetMenu(wxObject), typeof(Menu));
         }
         set {
            wxMenuItem_SetMenu(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int ID {
         get {
            return wxMenuItem_GetId(wxObject);
         }
         set {
            wxMenuItem_SetId(wxObject, value);
         }
      }
      ...
      public bool IsSeparator {
         get {
            return wxMenuItem_IsSeparator(wxObject);
         }
      }
      ...
      public string Text {
         set {
            wxMenuItem_SetText(wxObject, value);
         }
         get {
            return new wxString(wxMenuItem_GetText(wxObject), true);
         }
      }
      ...
      public string Label {
         get {
            return new wxString(wxMenuItem_GetLabel(wxObject), true);
         }
      }
      ...
      public ItemKind Kind {
         get {
            return (ItemKind)wxMenuItem_GetKind(wxObject);
         }
      }
      ...
      public bool Checkable {
         set {
            wxMenuItem_SetCheckable(wxObject, value);
         }
         get {
            return wxMenuItem_IsCheckable(wxObject);
         }
      }
      ...
      public bool IsSubMenu {
         get {
            return wxMenuItem_IsSubMenu(wxObject);
         }
      }

      public Menu SubMenu {
         set {
            wxMenuItem_SetSubMenu(wxObject, Object.SafePtr(value));
         }
         get {
            return (Menu)FindObject(wxMenuItem_GetSubMenu(wxObject), typeof(Menu));
         }
      }
      ...
      public bool Enabled {
         set {
            wxMenuItem_Enable(wxObject, value);
         }
         get {
            return wxMenuItem_IsEnabled(wxObject);
         }
      }
      ...
      public bool Checked {
         set {
            wxMenuItem_Check(wxObject, value);
         }
         get {
            return wxMenuItem_IsChecked(wxObject);
         }
      }
      ...
      public string Help {
         set {
            wxMenuItem_SetHelp(wxObject, value);
         }
         get {
            return new wxString(wxMenuItem_GetHelp(wxObject), true);
         }
      }
      ...
      public AcceleratorEntry Accel {
         get {
            return (AcceleratorEntry)Object.FindObject(wxMenuItem_GetAccel(wxObject), typeof(AcceleratorEntry));
         }
         set {
            wxMenuItem_SetAccel(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public string Name {
         set {
            wxMenuItem_SetName(wxObject, value);
         }
         get {
            return new wxString(wxMenuItem_GetName(wxObject), true);
         }
      }
      ...
      public Bitmap Bitmap {
         set {
            wxMenuItem_SetBitmap(wxObject, Object.SafePtr(value));
         }
         get {
            return (Bitmap)FindObject(wxMenuItem_GetBitmap(wxObject), typeof(Bitmap));
         }
      }
