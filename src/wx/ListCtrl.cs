...
//
// $Id: ListCtrl.cs,v 1.32 2004/12/05 17:56:12 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class ListItem : Object {
      ...
      public int Align {
         get {
            return wxListItem_GetAlign(wxObject);
         }
         set {
            wxListItem_SetAlign(wxObject, value);
         }
      }
      ...
      public Colour BackgroundColour {
         get {
            return new Colour(wxListItem_GetBackgroundColour(wxObject), true);
         }
         set {
            wxListItem_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int Column {
         get {
            return wxListItem_GetColumn(wxObject);
         }
         set {
            wxListItem_SetColumn(wxObject, value);
         }
      }
      ...
      public ClientData Data {
         get {
            return (ClientData)Object.FindObject(wxListItem_GetData(wxObject));
         }
         set {
      ...
      public Font Font {
         get {
            return new Font(wxListItem_GetFont(wxObject));
         }
         set {
            wxListItem_SetFont(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int Id {
         get {
            return wxListItem_GetId(wxObject);
         }
         set {
            wxListItem_SetId(wxObject, value);
         }
      }
      ...
      public int Image {
         get {
            return wxListItem_GetImage(wxObject);
         }
         set {
            wxListItem_SetImage(wxObject, value);
         }
      }
      ...
      public int Mask {
         get {
            return wxListItem_GetMask(wxObject);
         }
         set {
            wxListItem_SetMask(wxObject, value);
         }
      }
      ...
      public int State {
         get {
            return wxListItem_GetState(wxObject);
         }
         set {
            wxListItem_SetState(wxObject, value);
         }
      }

      public int StateMask {
         set {
            wxListItem_SetStateMask(wxObject, value);
         }
      }
      ...
      public string Text {
         get {
            return new wxString(wxListItem_GetText(wxObject), true);
         }
         set {
            wxListItem_SetText(wxObject, value);
         }
      }
      ...
      public Colour TextColour {
         get {
            return new Colour(wxListItem_GetTextColour(wxObject), true);
         }
         set {
            wxListItem_SetTextColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int Width {
         get {
            return wxListItem_GetWidth(wxObject);
         }
         set {
            wxListItem_SetWidth(wxObject, value);
         }
      }
      ...
      public ListItemAttr Attributes {
         get {
            return (ListItemAttr)FindObject(wxListItem_GetAttributes(wxObject), typeof(ListItemAttr));
         }
      }
   ...
   public class ListItemAttr : Object {
      ...
      public Colour TextColour {
         get {
            return new Colour(wxListItemAttr_GetTextColour(wxObject), true);
         }
         set {
            wxListItemAttr_SetTextColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour BackgroundColour {
         get {
            return new Colour(wxListItemAttr_GetBackgroundColour(wxObject), true);
         }
         set {
            wxListItemAttr_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Font Font {
         get {
            return new Font(wxListItemAttr_GetFont(wxObject), true);
         }
         set {
            wxListItemAttr_SetFont(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool HasTextColour {
         get {
            return wxListItemAttr_HasTextColour(wxObject);
         }
      }
      ...
      public bool HasBackgroundColour {
         get {
            return wxListItemAttr_HasBackgroundColour(wxObject);
         }
      }
      ...
      public bool HasFont {
         get {
            return wxListItemAttr_HasFont(wxObject);
         }
      }
   }
   ...
   public class ListCtrl : Control {
      ...
      public int CountPerPage {
         get {
            return wxListCtrl_GetCountPerPage(wxObject);
         }
      }
      ...
      public int ItemCount {
         get {
            return wxListCtrl_GetItemCount(wxObject);
         }
         set {
            wxListCtrl_SetItemCount(wxObject, value);
         }
      }
      ...
      public int ColumnCount {
         get {
            return wxListCtrl_GetColumnCount(wxObject);
         }
      }
      ...
      public int SelectedItemCount {
         get {
            return wxListCtrl_GetSelectedItemCount(wxObject);
         }
      }
      ...
      public Colour TextColour {
         get {
            return new Colour(wxListCtrl_GetTextColour(wxObject), true);
         }
         set {
            wxListCtrl_SetTextColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int TopItem {
         get {
            return wxListCtrl_GetTopItem(wxObject);
         }
      }
      ...
      public long WindowStyleFlag {
         set {
            wxListCtrl_SetWindowStyleFlag(wxObject, (uint)value);
         }
      }
   ...
   public class ListEvent : Event {
      ...
      public string Label {
         get {
            return new wxString(wxListEvent_GetLabel(wxObject), true);
         }
      }
      ...
      public int KeyCode {
         get {
            return wxListEvent_GetKeyCode(wxObject);
         }
      }
      ...
      public int Index {
         get {
            return wxListEvent_GetIndex(wxObject);
         }
      }
      ...
      public ListItem Item {
         get {
            return new ListItem(wxListEvent_GetItem(wxObject));
         }
      }
      ...
      public int Column {
         get {
            return wxListEvent_GetColumn(wxObject);
         }
      }
      ...
      public string Text {
         get {
            return new wxString(wxListEvent_GetText(wxObject), true);
         }
      }
      ...
      public int Image {
         get {
            return wxListEvent_GetImage(wxObject);
         }
      }
      ...
      public int Data {
         get {
            return wxListEvent_GetData(wxObject);
         }
      }
      ...
      public int Mask {
         get {
            return wxListEvent_GetMask(wxObject);
         }
      }
      ...
      public int CacheFrom {
         get {
            return wxListEvent_GetCacheFrom(wxObject);
         }
      }
      ...
      public int CacheTo {
         get {
            return wxListEvent_GetCacheTo(wxObject);
         }
      }
      ...
      public bool EditCancelled {
         get {
            return wxListEvent_IsEditCancelled(wxObject);
         }
         set {
            wxListEvent_SetEditCanceled(wxObject, value);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxListEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class ListView : ListCtrl {
      ...
      public long FocusedItem {
         get {
            return (long)wxListView_GetFocusedItem(wxObject);
         }
      }
      ...
      public long FirstSelected {
         get {
            return (long)wxListView_GetFirstSelected(wxObject);
         }
      }
