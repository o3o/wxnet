...
//
// $Id: Font.cs,v 1.16 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class Font : GDIObject, ICloneable {
      ...
      public int PointSize {
         get {
            return wxFont_GetPointSize(wxObject);
         }
         set {
            wxFont_SetPointSize(wxObject, value);
         }
      }

      public FontFamily Family {
         get {
            return (FontFamily)wxFont_GetFamily(wxObject);
         }
         set {
            wxFont_SetFamily(wxObject, (int)value);
         }
      }

      public FontStyle Style {
         get {
            return (FontStyle)wxFont_GetStyle(wxObject);
         }
         set {
            wxFont_SetStyle(wxObject, (int)value);
         }
      }

      public FontEncoding Encoding {
         get {
            return (FontEncoding)wxFont_GetEncoding(wxObject);
         }
         set {
            wxFont_SetEncoding(wxObject, (int)value);
         }
      }

      public FontWeight Weight {
         get {
            return (FontWeight)wxFont_GetWeight(wxObject);
         }
         set {
            wxFont_SetWeight(wxObject, (int)value);
         }
      }

      public bool Underlined {
         get {
            return wxFont_GetUnderlined(wxObject);
         }
         set {
            wxFont_SetUnderlined(wxObject, value);
         }
      }

      public string FaceName {
         get {
            return new wxString(wxFont_GetFaceName(wxObject), true);
         }
         set {
            wxFont_SetFaceName(wxObject, value);
         }
      }

      public string FamilyString {
         get {
            return new wxString(wxFont_GetFamilyString(wxObject), true);
         }
      }

      public string StyleString {
         get {
            return new wxString(wxFont_GetStyleString(wxObject), true);
         }
      }
      ...
      public bool IsFixedWidth {
         get {
            return wxFont_IsFixedWidth(wxObject);
         }
      }

      public bool Ok {
         get {
            return wxFont_Ok(wxObject);
         }
      }

      public IntPtr NativeFontInfo {
         get {
            return wxFont_GetNativeFontInfo(wxObject);
         }
      }

      public string NativeFontInfoUserDesc {
         get {
            return new wxString(wxFont_GetNativeFontInfoUserDesc(wxObject), true);
         }
      }

      public string NativeFontInfoDesc {
         get {
            return new wxString(wxFont_GetNativeFontInfoDesc(wxObject), true);
         }
      }
