...
//
// $Id: SplashScreen.cs,v 1.8 2004/12/06 17:00:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class SplashScreen : Frame {
      ...
      public long SplashStyle {
         get {
            return (long)wxSplashScreen_GetSplashStyle(wxObject);
         }
      }
      ...
      public SplashScreenWindow SplashWindow {
         get {
            return (SplashScreenWindow)FindObject(wxSplashScreen_GetSplashWindow(wxObject), typeof(SplashScreenWindow));
         }
      }
      ...
      public int Timeout {
         get {
            return wxSplashScreen_GetTimeout(wxObject);
         }
      }
   }
   ...
   public class SplashScreenWindow : Window {
      ...
      public Bitmap Bitmap {
         set {
            wxSplashScreenWindow_SetBitmap(wxObject, Object.SafePtr(value));
         }
         get {
            return (Bitmap)FindObject(wxSplashScreenWindow_GetBitmap(wxObject));
         }
      }
   }
}
