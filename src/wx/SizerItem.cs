...
namespace wx {
   public class SizerItem : Object {
      ...
      public float Ratio {
         set {
            wxSizerItem_SetRatioFloat(wxObject, value);
         }
         get {
            return wxSizerItem_GetRatioFloat(wxObject);
         }
      }
      ...
      public bool IsWindow {
         get {
            return wxSizerItem_IsWindow(wxObject);
         }
      }

      public bool IsSizer {
         get {
            return wxSizerItem_IsSizer(wxObject);
         }
      }

      public bool IsSpacer {
         get {
            return wxSizerItem_IsSpacer(wxObject);
         }
      }
      ...
      public int Proportion {
         set {
            wxSizerItem_SetProportion(wxObject, value);
         }
         get {
            return wxSizerItem_GetProportion(wxObject);
         }
      }
      ...
      public int Flag {
         set {
            wxSizerItem_SetFlag(wxObject, value);
         }
         get {
            return wxSizerItem_GetFlag(wxObject);
         }
      }
      ...
      public int Border {
         set {
            wxSizerItem_SetBorder(wxObject, value);
         }
         get {
            return wxSizerItem_GetBorder(wxObject);
         }
      }
      ...
      public Window Window {
         get {
            return (Window)FindObject(wxSizerItem_GetWindow(wxObject));
         }
         set {
            wxSizerItem_SetWindow(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Sizer Sizer {
         get {
            return (Sizer)FindObject(wxSizerItem_GetSizer(wxObject));
         }
         set {
            wxSizerItem_SetSizer(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Size Spacer {
         ...
         set {
            wxSizerItem_SetSpacer(wxObject, ref value);
         }
      }
      ...
      public bool IsShown {
         get {
            return wxSizerItem_IsShown(wxObject);
         }
      }
      ...
      public Object UserData {
         get {
            return (Object)FindObject(wxSizerItem_GetUserData(wxObject));
         }
      }
