...
//
// $Id: HtmlHelpController.cs,v 1.1 2004/10/27 16:53:22 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class HtmlHelpController : Object {
      ...
      public string TitleFormat {
         set {
            wxHtmlHelpController_SetTitleFormat(wxObject, value);
         }
      }
      ...
      public string TempDir {
         set {
            wxHtmlHelpController_SetTempDir(wxObject, value);
         }
      }
