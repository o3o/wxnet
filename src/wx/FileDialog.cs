...
//
// $Id: FileDialog.cs,v 1.9 2004/11/24 20:47:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class FileDialog : Dialog {
      ...
      public string Directory {
         get {
            return new wxString(wxFileDialog_GetDirectory(wxObject), true);
         }
         set {
            wxFileDialog_SetDirectory(wxObject, value);
         }
      }

      public string Filename {
         get {
            return new wxString(wxFileDialog_GetFilename(wxObject), true);
         }
         set {
            wxFileDialog_SetFilename(wxObject, value);
         }
      }

      public string Path {
         get {
            return new wxString(wxFileDialog_GetPath(wxObject), true);
         }
         set {
            wxFileDialog_SetPath(wxObject, value);
         }
      }
      ...
      public int FilterIndex {
         ...
         get {
            return wxFileDialog_GetFilterIndex(wxObject);
         }
      }

      public string Message {
         set {
            wxFileDialog_SetMessage(wxObject,value);
         }
         get {
            return new wxString(wxFileDialog_GetMessage(wxObject), true);
         }
      }
      ...
      public string Wildcard {
         get {
            return new wxString(wxFileDialog_GetWildcard(wxObject), true);
         }
         set {
            wxFileDialog_SetWildcard(wxObject, value);
         }
      }

      public long Style {
         get {
            return (long)wxFileDialog_GetStyle(wxObject);
         }
         set {
            wxFileDialog_SetStyle(wxObject, (int)value);
         }
      }
      ...
      public string[] Paths {
         get {
            return new ArrayString(wxFileDialog_GetPaths(wxObject), true);
         }
      }

      public string[] Filenames {
         get {
            return new ArrayString(wxFileDialog_GetFilenames(wxObject), true);
         }
      }
   }
}
