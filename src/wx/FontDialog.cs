...
//
// $Id: FontDialog.cs,v 1.4 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class FontData : Object {
      ...
      public bool AllowSymbols {
         get {
            return wxFontData_GetAllowSymbols(wxObject);
         }
         set {
            wxFontData_SetAllowSymbols(wxObject, value);
         }
      }
      ...
      public bool EffectsEnabled {
         get {
            return wxFontData_GetEnableEffects(wxObject);
         }
         set {
            wxFontData_EnableEffects(wxObject, value);
         }
      }
      ...
      public bool ShowHelp {
         get {
            return wxFontData_GetShowHelp(wxObject);
         }
         set {
            wxFontData_SetShowHelp(wxObject, value);
         }
      }
