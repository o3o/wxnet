...
//
// $Id: DataFormat.cs,v 1.4 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class DataFormat : Object {
      ...
      public string Id {
         get {
            return wxDataFormat_GetId(wxObject);
         }
         set {
            wxDataFormat_SetId(wxObject, value);
         }
      }
      ...
      public DataFormatId Type {
         get {
            return (DataFormatId)wxDataFormat_GetType(wxObject);
         }
         set {
            wxDataFormat_SetType(wxObject, (int)value);
         }
      }
   }
}
