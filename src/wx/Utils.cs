...
//
// $Id: Utils.cs,v 1.10 2004/11/27 21:29:53 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class ArrayInt : Object {
      ...
      public int Count {
         get {
            return wxArrayInt_GetCount(wxObject);
         }
      }
   ...
   public class ArrayString : Object {
      ...
      public int Count {
         get {
            return wxArrayString_GetCount(wxObject);
         }
      }
   ...
   public class wxSize : Object {
      ...
      public int Width {
         get {
            return wxSize_GetWidth(wxObject);
         }
         set {
            wxSize_SetWidth(wxObject, value);
         }
      }

      public int Height {
         get {
            return wxSize_GetHeight(wxObject);
         }
         set {
            wxSize_SetHeight(wxObject, value);
         }
      }
   ...
   public class wxRect : Object {
      ...
      public int X {
         get {
            return wxRect_GetX(wxObject);
         }
         set {
            wxRect_SetX(wxObject, value);
         }
      }

      public int Y {
         get {
            return wxRect_GetY(wxObject);
         }
         set {
            wxRect_SetY(wxObject, value);
         }
      }

      public int Width {
         get {
            return wxRect_GetWidth(wxObject);
         }
         set {
            wxRect_SetWidth(wxObject, value);
         }
      }

      public int Height {
         get {
            return wxRect_GetHeight(wxObject);
         }
         set {
            wxRect_SetHeight(wxObject, value);
         }
      }
