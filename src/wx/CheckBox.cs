...
//
// $Id: CheckBox.cs,v 1.13 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class CheckBox : Control {
      ...
      public bool Value {
         get {
            return wxCheckBox_GetValue(wxObject);
         }
         set {
            wxCheckBox_SetValue(wxObject, value);
         }
      }
      ...
      public bool IsChecked {
         get {
            return wxCheckBox_IsChecked(wxObject);
         }
      }
      ...
      public CheckBoxState ThreeStateValue {
         get {
            return wxCheckBox_Get3StateValue(wxObject);
         }
         set {
            wxCheckBox_Set3StateValue(wxObject, value);
         }
      }
