...
//
// $Id: DataObject.cs,v 1.8 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class TextDataObject : DataObjectSimple {
      ...
      public int TextLength {
         get {
            return wxTextDataObject_GetTextLength(wxObject);
         }
      }
      ...
      public string Text {
         get {
            return new wxString(wxTextDataObject_GetText(wxObject), true);
         }
         set {
            wxTextDataObject_SetText(wxObject, value);
         }
      }
   }
   ...
   public class FileDataObject : DataObjectSimple {
      ...
      public string[] Filenames {
         get {
            return new ArrayString(wxFileDataObject_GetFilenames(wxObject), true);
         }
      }
   }
}
