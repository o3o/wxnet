...
//
// $Id: TabCtrl.cs,v 1.7 2004/11/24 20:47:44 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class TabEvent : Event {
      ...
      public int Selection {
         get {
            return wxTabEvent_GetSelection(wxObject);
         }
         set {
            wxTabEvent_SetSelection(wxObject, value);
         }
      }
      ...
      public int OldSelection {
         get {
            return wxTabEvent_GetOldSelection(wxObject);
         }
         set {
            wxTabEvent_SetOldSelection(wxObject, value);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxTabEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class TabCtrl : Control {
      ...
      public int Selection {
         get {
            return wxTabCtrl_GetSelection(wxObject);
         }
         set {
            wxTabCtrl_SetSelection(wxObject, value);
         }
      }
      ...
      public int CurFocus {
         get {
            return wxTabCtrl_GetCurFocus(wxObject);
         }
      }
      ...
      public ImageList ImageList {
         get {
            return (ImageList)FindObject(wxTabCtrl_GetImageList(wxObject), typeof(ImageList));
         }
         set {
            wxTabCtrl_SetImageList(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int ItemCount {
         get {
            return wxTabCtrl_GetItemCount(wxObject);
         }
      }
      ...
      public int RowCount {
         get {
            return wxTabCtrl_GetRowCount(wxObject);
         }
      }
      ...
      public Size ItemSize {
         set {
            wxTabCtrl_SetItemSize(wxObject, ref value);
         }
      }
      ...
      public Size Padding {
         set {
            wxTabCtrl_SetPadding(wxObject, ref value);
         }
      }
