...
//
// $Id: Gauge.cs,v 1.9 2004/10/24 12:48:38 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Gauge :  Control {
      ...
      public int Range {
         get {
            return wxGauge_GetRange(wxObject);
         }
         set {
            wxGauge_SetRange(wxObject, value);
         }
      }
      ...
      public int Value {
         get {
            return wxGauge_GetValue(wxObject);
         }
         set {
            wxGauge_SetValue(wxObject, value);
         }
      }
      ...
      public int ShadowWidth {
         get {
            return wxGauge_GetShadowWidth(wxObject);
         }
         set {
            wxGauge_SetShadowWidth(wxObject, value);
         }
      }
      ...
      public int BezelFace {
         get {
            return wxGauge_GetBezelFace(wxObject);
         }
         set {
            wxGauge_SetBezelFace(wxObject, value);
         }
      }
      ...
      public bool IsVertical {
         get {
            return wxGauge_IsVertical(wxObject);
         }
      }
   }
}
