...
//
// $Id: ComboBox.cs,v 1.17 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class ComboBox : Control {
      ...
      public int Selection {
         get {
            return wxComboBox_GetSelection(wxObject);
         }
         set {
            wxComboBox_SetSelectionSingle(wxObject, value);
         }
      }
      ...
      public string StringSelection {
         get {
            return new wxString(wxComboBox_GetStringSelection(wxObject), true);
         }
         set {
            wxComboBox_SetStringSelection(wxObject, value);
         }
      }
      ...
      public int Count {
         get {
            return wxComboBox_GetCount(wxObject);
         }
      }
      ...
      public long InsertionPoint {
         get {
            return wxComboBox_GetInsertionPoint(wxObject);
         }
         set {
            wxComboBox_SetInsertionPoint(wxObject, (uint)value);
         }
      }
      ...
      public bool Editable {
         set {
            wxComboBox_SetEditable(wxObject, value);
         }
      }
      ...
      public string Value {
         get {
            return new wxString(wxComboBox_GetValue(wxObject), true);
         }
         set {
            wxComboBox_SetValue(wxObject, value);
         }
      }
