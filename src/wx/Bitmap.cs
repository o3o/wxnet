...
//
// $Id: Bitmap.cs,v 1.21 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class Bitmap : GDIObject {
      ...
      public int Height {
         get {
            return wxBitmap_GetHeight(wxObject);
         }
         set {
      ...
      public int Width {
         get {
            return wxBitmap_GetWidth(wxObject);
         }
         set {
      ...
      public int Depth {
         get {
            return wxBitmap_GetDepth(wxObject);
         }
         set {
      ...
      public Mask Mask {
         get {
            return new Mask(wxBitmap_GetMask(wxObject));
         }
         set {
      ...
      public Palette Palette {
         get {
            return new Palette(wxBitmap_GetPalette(wxObject));
         }
      }
      ...
      public Palette ColourMap {
         get {
            return new Palette(wxBitmap_GetColourMap(wxObject));
         }
      }
