...
//
// $Id: RadioBox.cs,v 1.11 2004/11/24 20:47:44 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class RadioBox : Control {
      ...
      public int Selection {
         set {
            wxRadioBox_SetSelection(wxObject, value);
         }
         get {
            return wxRadioBox_GetSelection(wxObject);
         }
      }

      public string StringSelection {
         set {
            wxRadioBox_SetStringSelection(wxObject, value);
         }
         get {
            return new wxString(wxRadioBox_GetStringSelection(wxObject), true);
         }
      }
      ...
      public int Count {
         get {
            return wxRadioBox_GetCount(wxObject);
         }
      }
      ...
      public new string Label {
         get {
            return new wxString(wxRadioBox_GetLabel(wxObject), true);
         }
         set {
            wxRadioBox_SetLabel(wxObject, value);
         }
      }
