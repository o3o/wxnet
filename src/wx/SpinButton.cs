...
// $Id: SpinButton.cs,v 1.9 2004/07/31 17:06:11 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class SpinEvent : CommandEvent {
      ...
      public int Position {
         get {
            return wxSpinEvent_GetPosition(wxObject);
         }
         set {
            wxSpinEvent_SetPosition(wxObject, value);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxSpinEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class SpinButton : Control {
      ...
      public int Value {
         get {
            return wxSpinButton_GetValue(wxObject);
         }
         set {
            wxSpinButton_SetValue(wxObject, value);
         }
      }
      ...
      public int Max {
         get {
            return wxSpinButton_GetMax(wxObject);
         }
      }

      public int Min {
         get {
            return wxSpinButton_GetMin(wxObject);
         }
      }
