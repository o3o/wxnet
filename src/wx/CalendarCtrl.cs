...
//
// $Id: CalendarCtrl.cs,v 1.9 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class CalendarCtrl : Control {
      ...
      public DateTime Date {
         set {
            wxCalendarCtrl_SetDate(wxObject, Object.SafePtr((wxDateTime)value));
         }
         get {
            return new wxDateTime(wxCalendarCtrl_GetDate(wxObject));
         }
      }
      ...
      public DateTime LowerDateLimit {
         set {
            wxCalendarCtrl_SetLowerDateLimit(wxObject, Object.SafePtr((wxDateTime)value));
         }
         get {
            return new wxDateTime(wxCalendarCtrl_GetLowerDateLimit(wxObject));
         }
      }

      public DateTime UpperDateLimit {
         set {
            wxCalendarCtrl_SetUpperDateLimit(wxObject, Object.SafePtr((wxDateTime)value));
         }
         get {
            return new wxDateTime(wxCalendarCtrl_GetUpperDateLimit(wxObject));
         }
      }
      ...
      public bool EnableYearChange {
         set {
            wxCalendarCtrl_EnableYearChange(wxObject, value);
         }
      }

      public bool EnableMonthChange {
         set {
            wxCalendarCtrl_EnableMonthChange(wxObject, value);
         }
      }

      public bool EnableHolidayDisplay {
         set {
            wxCalendarCtrl_EnableHolidayDisplay(wxObject, value);
         }
      }
      ...
      public Colour HeaderColourFg {
         get {
            return new Colour(wxCalendarCtrl_GetHeaderColourFg(wxObject), true);
         }
      }

      public Colour HeaderColourBg {
         get {
            return new Colour(wxCalendarCtrl_GetHeaderColourBg(wxObject), true);
         }
      }
      ...
      public Colour HighlightColourFg {
         get {
            return new Colour(wxCalendarCtrl_GetHighlightColourFg(wxObject));
         }
      }

      public Colour HighlightColourBg {
         get {
            return new Colour(wxCalendarCtrl_GetHighlightColourBg(wxObject));
         }
      }
      ...
      public Colour HolidayColourFg {
         get {
            return new Colour(wxCalendarCtrl_GetHolidayColourFg(wxObject));
         }
      }

      public Colour HolidayColourBg {
         get {
            return new Colour(wxCalendarCtrl_GetHolidayColourBg(wxObject));
         }
      }
   ...
   public class CalendarDateAttr : Object {
      ...
      public Colour TextColour {
         set {
            wxCalendarDateAttr_SetTextColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxCalendarDateAttr_GetTextColour(wxObject));
         }
      }
      ...
      public Colour BackgroundColour {
         set {
            wxCalendarDateAttr_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxCalendarDateAttr_GetBackgroundColour(wxObject));
         }
      }
      ...
      public Colour BorderColour {
         set {
            wxCalendarDateAttr_SetBorderColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxCalendarDateAttr_GetBorderColour(wxObject));
         }
      }
      ...
      public Font Font {
         set {
            wxCalendarDateAttr_SetFont(wxObject, Object.SafePtr(value));
         }
         get {
            return new Font(wxCalendarDateAttr_GetFont(wxObject));
         }
      }
      ...
      public CalendarDateBorder Border {
         set {
            wxCalendarDateAttr_SetBorder(wxObject, (int)value);
         }
         get {
            return (CalendarDateBorder)wxCalendarDateAttr_GetBorder(wxObject);
         }
      }
      ...
      public bool IsHoliday {
         set {
            wxCalendarDateAttr_SetHoliday(wxObject, value);
         }
         get {
            return wxCalendarDateAttr_IsHoliday(wxObject);
         }
      }
      ...
      public bool HasTextColour {
         get {
            return wxCalendarDateAttr_HasTextColour(wxObject);
         }
      }

      public bool HasBackgroundColour {
         get {
            return wxCalendarDateAttr_HasBackgroundColour(wxObject);
         }
      }

      public bool HasBorderColour {
         get {
            return wxCalendarDateAttr_HasBorderColour(wxObject);
         }
      }

      public bool HasFont {
         get {
            return wxCalendarDateAttr_HasFont(wxObject);
         }
      }

      public bool HasBorder {
         get {
            return wxCalendarDateAttr_HasBorder(wxObject);
         }
      }
   ...
   public class CalendarEvent : CommandEvent {
      ...
      public DateTime Date {
         get {
            return new wxDateTime(wxCalendarEvent_GetDate(wxObject));
         }
      }

      public DayOfWeek WeekDay {
         get {
            return (DayOfWeek)wxCalendarEvent_GetWeekDay(wxObject);
         }
      }
   }
}
