...
//
// $Id: FindReplaceDialog.cs,v 1.8 2004/11/24 20:47:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class FindReplaceDialog : Dialog {
      ...
      public FindReplaceData Data {
         get {
            return (FindReplaceData)FindObject(wxFindReplaceDialog_GetData(wxObject), typeof(FindReplaceData));
         }
         set {
            wxFindReplaceDialog_SetData(wxObject, Object.SafePtr(value));
         }
      }
   ...
   public class FindDialogEvent : CommandEvent {
      ...
      public int Flags {
         get {
            return wxFindDialogEvent_GetFlags(wxObject);
         }
         set {
            wxFindDialogEvent_SetFlags(wxObject, value);
         }
      }
      ...
      public string FindString {
         get {
            return new wxString(wxFindDialogEvent_GetFindString(wxObject), true);
         }
         set {
            wxFindDialogEvent_SetFindString(wxObject, value);
         }
      }
      ...
      public string ReplaceString {
         get {
            return new wxString(wxFindDialogEvent_GetReplaceString(wxObject), true);
         }
         set {
            wxFindDialogEvent_SetReplaceString(wxObject, value);
         }
      }
      ...
      public FindReplaceDialog Dialog {
         get {
            return (FindReplaceDialog)FindObject(wxFindDialogEvent_GetDialog(wxObject));
         }
      }
   }
   ...
   public class FindReplaceData : Object {
      ...
      public string FindString {
         get {
            return new wxString(wxFindReplaceData_GetFindString(wxObject), true);
         }
         set {
            wxFindReplaceData_SetFindString(wxObject, value);
         }
      }
      ...
      public string ReplaceString {
         get {
            return new wxString(wxFindReplaceData_GetReplaceString(wxObject), true);
         }
         set {
            wxFindReplaceData_SetReplaceString(wxObject, value);
         }
      }
      ...
      public int Flags {
         get {
            return wxFindReplaceData_GetFlags(wxObject);
         }
         set {
            wxFindReplaceData_SetFlags(wxObject, value);
         }
      }
   }
}
