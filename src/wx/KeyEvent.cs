...
//
// $Id: KeyEvent.cs,v 1.7 2004/12/05 17:56:12 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class KeyEvent : Event {
      ...
      public bool ControlDown {
         get {
            return wxKeyEvent_ControlDown(wxObject);
         }
      }

      public bool MetaDown {
         get {
            return wxKeyEvent_MetaDown(wxObject);
         }
      }

      public bool ShiftDown {
         get {
            return wxKeyEvent_ShiftDown(wxObject);
         }
      }

      public bool AltDown {
         get {
            return wxKeyEvent_AltDown(wxObject);
         }
      }
      ...
      public int KeyCode {
         get {
            return wxKeyEvent_GetKeyCode(wxObject);
         }
      }

      public long RawKeyCode {
         get {
            return wxKeyEvent_GetRawKeyCode(wxObject);
         }
      }
      ...
      public long RawKeyFlags {
         get {
            return wxKeyEvent_GetRawKeyFlags(wxObject);
         }
      }
      ...
      public bool HasModifiers {
         get {
            return wxKeyEvent_HasModifiers(wxObject);
         }
      }
      ...
      public int X {
         get {
            return wxKeyEvent_GetX(wxObject);
         }
      }

      public int Y {
         get {
            return wxKeyEvent_GetY(wxObject);
         }
      }
      ...
      public bool CmdDown {
         get {
            return wxKeyEvent_CmdDown(wxObject);
         }
      }
   }
}
