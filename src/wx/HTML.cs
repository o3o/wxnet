...
namespace wx {
   ...
   public class HtmlWindow : ScrolledWindow {
      ...
      public string OpenedPage {
         get {
            return new wxString(wxHtmlWindow_GetOpenedPage(wxObject), true);
         }
      }

      public string OpenedAnchor {
         get {
            return new wxString(wxHtmlWindow_GetOpenedAnchor(wxObject), true);
         }
      }

      public string OpenedPageTitle {
         get {
            return new wxString(wxHtmlWindow_GetOpenedPageTitle(wxObject), true);
         }
      }
      ...
      public Frame RelatedFrame {
         get {
            return (Frame)FindObject(wxHtmlWindow_GetRelatedFrame(wxObject), typeof(Frame));
         }
      }
      ...
      public int RelatedStatusBar {
         set {
            wxHtmlWindow_SetRelatedStatusBar(wxObject, value);
         }
      }
      ...
      public int Borders {
         set {
            wxHtmlWindow_SetBorders(wxObject, value);
         }
      }
      ...
      public HtmlContainerCell InternalRepresentation {
         get {
            return (HtmlContainerCell)FindObject(wxHtmlWindow_GetInternalRepresentation(wxObject), typeof(HtmlContainerCell));
         }
      }
      ...
      public HtmlWinParser Parser {
         get {
            return (HtmlWinParser)FindObject(wxHtmlWindow_GetParser(wxObject), typeof(HtmlWinParser));
         }
      }
      ...
      public string Text {
         get {
            return new wxString(wxHtmlWindow_ToText(wxObject), true);
         }
      }
      ...
      public string SelectionText {
         get {
            return new wxString(wxHtmlWindow_SelectionToText(wxObject), true);
         }
      }
   }
   ...
   public class HtmlLinkInfo : Object {
      ...
      public MouseEvent Event {
         set {
            wxHtmlLinkInfo_SetEvent(wxObject, Object.SafePtr(value));
         }
         get {
            return (MouseEvent)FindObject(wxHtmlLinkInfo_GetEvent(wxObject), typeof(MouseEvent));
         }
      }
      ...
      public string Href {
         get {
            return new wxString(wxHtmlLinkInfo_GetHref(wxObject), true);
         }
      }
      ...
      public string Target {
         get {
            return new wxString(wxHtmlLinkInfo_GetTarget(wxObject), true);
         }
      }
      ...
      public HtmlCell HtmlCell {
         get {
            return (HtmlCell)FindObject(wxHtmlLinkInfo_GetHtmlCell(wxObject), typeof(HtmlCell));
         }
         set {
            wxHtmlLinkInfo_SetHtmlCell(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public class HtmlCell : Object {
      ...
      public HtmlContainerCell Parent {
         set {
            wxHtmlCell_SetParent(wxObject, Object.SafePtr(value));
         }
         get {
            return (HtmlContainerCell)FindObject(wxHtmlCell_GetParent(wxObject), typeof(HtmlContainerCell));
         }
      }
      ...
      public int PosX {
         get {
            return wxHtmlCell_GetPosX(wxObject);
         }
      }

      public int PosY {
         get {
            return wxHtmlCell_GetPosY(wxObject);
         }
      }

      public int Width {
         get {
            return wxHtmlCell_GetWidth(wxObject);
         }
      }

      public int Height {
         get {
            return wxHtmlCell_GetHeight(wxObject);
         }
      }
      ...
      public int Descent {
         get {
            return wxHtmlCell_GetDescent(wxObject);
         }
      }
      ...
      public virtual string Id {
         get {
            return new wxString(wxHtmlCell_GetId(wxObject), true);
         }
         set {
            wxHtmlCell_SetId(wxObject, value);
         }
      }
      ...
      public HtmlCell Next {
         get {
            return (HtmlCell)FindObject(wxHtmlCell_GetNext(wxObject), typeof(HtmlCell));
         }
         set {
            wxHtmlCell_SetNext(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public HtmlLinkInfo Link {
         set {
            wxHtmlCell_SetLink(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool CanLiveOnPagebreak {
         set {
            wxHtmlCell_SetCanLiveOnPagebreak(wxObject, value);
         }
      }
      ...
      public virtual bool IsTerminalCell {
         get {
            return wxHtmlCell_IsTerminalCell(wxObject);
         }
      }
   ...
   public class HtmlContainerCell : HtmlCell {
      ...
      public int AlignHor {
         set {
            wxHtmlContainerCell_SetAlignHor(wxObject, value);
         }
         get {
            return wxHtmlContainerCell_GetAlignHor(wxObject);
         }
      }
      ...
      public int AlignVer {
         set {
            wxHtmlContainerCell_SetAlignVer(wxObject, value);
         }
         get {
            return wxHtmlContainerCell_GetAlignVer(wxObject);
         }
      }
      ...
      public HtmlTag Align {
         set {
            wxHtmlContainerCell_SetAlign(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour BackgroundColour {
         set {
            wxHtmlContainerCell_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxHtmlContainerCell_GetBackgroundColour(wxObject), true);
         }
      }
      ...
      public HtmlCell FirstCell {
         get {
            return wxHtmlContainerCell_GetFirstCell(wxObject);
         }
      }
      ...
      public override bool IsTerminalCell {
         get {
            return wxHtmlContainerCell_IsTerminalCell(wxObject);
         }
      }
   ...
   public class HtmlTag : Object {
      ...
      public HtmlTag Parent {
         get {
            return wxHtmlTag_GetParent(wxObject);
         }
      }

      public HtmlTag FirstSibling {
         get {
            return wxHtmlTag_GetFirstSibling(wxObject);
         }
      }

      public HtmlTag LastSibling {
         get {
            return wxHtmlTag_GetLastSibling(wxObject);
         }
      }

      public HtmlTag Children {
         get {
            return wxHtmlTag_GetChildren(wxObject);
         }
      }
      ...
      public HtmlTag PreviousSibling {
         get {
            return wxHtmlTag_GetPreviousSibling(wxObject);
         }
      }

      public HtmlTag NextSibling {
         get {
            return wxHtmlTag_GetNextSibling(wxObject);
         }
      }
      ...
      public HtmlTag NextTag {
         get {
            return wxHtmlTag_GetNextTag(wxObject);
         }
      }
      ...
      public string Name {
         get {
            return new wxString(wxHtmlTag_GetName(wxObject), true);
         }
      }
      ...
      public string AllParams {
         get {
            return new wxString(wxHtmlTag_GetAllParams(wxObject), true);
         }
      }
      ...
      public bool IsEnding {
         get {
            return wxHtmlTag_IsEnding(wxObject);
         }
      }

      public bool HasEnding {
         get {
            return wxHtmlTag_HasEnding(wxObject);
         }
      }
      ...
      public int BeginPos {
         get {
            return wxHtmlTag_GetBeginPos(wxObject);
         }
      }

      public int EndPos1 {
         get {
            return wxHtmlTag_GetEndPos1(wxObject);
         }
      }

      public int EndPos2 {
         get {
            return wxHtmlTag_GetEndPos2(wxObject);
         }
      }
   ...
   public class HtmlWinParser : HtmlParser {
      ...
      public override Object Product {
         get {
            return FindObject(wxHtmlWinParser_GetProduct(wxObject), typeof(Object));
         }
      }
      ...
      public DC DC {
         get {
            return (DC)FindObject(wxHtmlWinParser_GetDC(wxObject), typeof(DC));
         }
      }
      ...
      public double PixelScale {
         get {
            return wxHtmlWinParser_GetPixelScale(wxObject);
         }
      }
      ...
      public int CharHeight {
         get {
            return wxHtmlWinParser_GetCharHeight(wxObject);
         }
      }

      public int CharWidth {
         get {
            return wxHtmlWinParser_GetCharWidth(wxObject);
         }
      }
      ...
      public HtmlWindow Window {
         get {
            return (HtmlWindow)FindObject(wxHtmlWinParser_GetWindow(wxObject), typeof(HtmlWindow));
         }
      }
      ...
      public HtmlContainerCell Container {
         get {
            return (HtmlContainerCell)FindObject(wxHtmlWinParser_GetContainer(wxObject), typeof(HtmlContainerCell));
         }
      }
      ...
      public int FontSize {
         get {
            return wxHtmlWinParser_GetFontSize(wxObject);
         }
         set {
            wxHtmlWinParser_SetFontSize(wxObject, value);
         }
      }

      public int FontBold {
         get {
            return wxHtmlWinParser_GetFontBold(wxObject);
         }
         set {
            wxHtmlWinParser_SetFontBold(wxObject, value);
         }
      }

      public int FontItalic {
         get {
            return wxHtmlWinParser_GetFontItalic(wxObject);
         }
         set {
            wxHtmlWinParser_SetFontItalic(wxObject, value);
         }
      }

      public int FontUnderlined {
         get {
            return wxHtmlWinParser_GetFontUnderlined(wxObject);
         }
         set {
            wxHtmlWinParser_SetFontUnderlined(wxObject, value);
         }
      }

      public int FontFixed {
         get {
            return wxHtmlWinParser_GetFontFixed(wxObject);
         }
         set {
            wxHtmlWinParser_SetFontFixed(wxObject, value);
         }
      }

      public string FontFace {
         get {
            return new wxString(wxHtmlWinParser_GetFontFace(wxObject), true);
         }
         set {
            wxHtmlWinParser_SetFontFace(wxObject, value);
         }
      }
      ...
      public int Align {
         get {
            return wxHtmlWinParser_GetAlign(wxObject);
         }
         set {
            wxHtmlWinParser_SetAlign(wxObject, value);
         }
      }
      ...
      public Colour LinkColor {
         get {
            return new Colour(wxHtmlWinParser_GetLinkColor(wxObject), true);
         }
         set {
            wxHtmlWinParser_SetLinkColor(wxObject, Object.SafePtr(value));
         }
      }

      public Colour ActualColor {
         get {
            return new Colour(wxHtmlWinParser_GetActualColor(wxObject), true);
         }
         set {
            wxHtmlWinParser_SetActualColor(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public HtmlLinkInfo Link {
         get {
            return (HtmlLinkInfo)FindObject(wxHtmlWinParser_GetLink(wxObject), typeof(HtmlLinkInfo));
         }
         set {
            wxHtmlWinParser_SetLink(wxObject, Object.SafePtr(value));
         }
      }
   ...
   public class HtmlEntitiesParser : Object {
      ...
      public FontEncoding Encoding {
         set {
            wxHtmlEntitiesParser_SetEncoding(wxObject, (int)value);
         }
      }
   ...
   public abstract class HtmlParser : Object {
      ...
      public abstract Object Product {
         get;
      }
      ...
      public string Source {
         get {
            return new wxString(wxHtmlParser_GetSource(wxObject), true);
         }
         set {
            wxHtmlParser_SetSource(wxObject, value);
         }
      }

      public string SourceAndSaveState {
         set {
            wxHtmlParser_SetSourceAndSaveState(wxObject, value);
         }
      }
   ...
   public abstract class HtmlProcessor : Object {
      ...
      public int Priority {
         get {
            return wxHtmlProcessor_GetPriority(wxObject);
         }
      }
      ...
      public bool Enabled {
         set {
            wxHtmlProcessor_Enable(wxObject, value);
         }
         get {
            return wxHtmlProcessor_IsEnabled(wxObject);
         }
      }
   }
   ...
   public class HtmlRenderingInfo : Object {
      ...
      public HtmlSelection Selection {
         get {
            return (HtmlSelection)FindObject(wxHtmlRenderingInfo_GetSelection(wxObject), typeof(HtmlSelection));
         }
         set {
            wxHtmlRenderingInfo_SetSelection(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public class HtmlSelection : Object {
      ...
      public HtmlCell FromCell {
         get {
            return (HtmlCell)Object.FindObject(wxHtmlSelection_GetFromCell(wxObject), typeof(HtmlCell));
         }
      }

      public HtmlCell ToCell {
         get {
            return (HtmlCell)Object.FindObject(wxHtmlSelection_GetToCell(wxObject), typeof(HtmlCell));
         }
      }
      ...
      public Point FromPrivPos {
         ...
         set {
            wxHtmlSelection_SetFromPrivPos(wxObject, ref value);
         }
      }
      ...
      public Point ToPrivPos {
         ...
         set {
            wxHtmlSelection_SetToPrivPos(wxObject, ref value);
         }
      }
      ...
      public bool Empty {
         get {
            return wxHtmlSelection_IsEmpty(wxObject);
         }
      }
   }
   ...
   public class HtmlEasyPrinting : Object {
      ...
      public PrintData PrintData {
         get {
            return (PrintData)FindObject(wxHtmlEasyPrinting_GetPrintData(wxObject), typeof(PrintData));
         }
      }
      ...
      public PageSetupDialogData PageSetupData {
         get {
            return (PageSetupDialogData)FindObject(wxHtmlEasyPrinting_GetPageSetupData(wxObject), typeof(PageSetupDialogData));
         }
      }
   }
}
