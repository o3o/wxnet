...
//
// $Id: CommandEvent.cs,v 1.10 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class CommandEvent : Event {
      ...
      public int Selection {
         get {
            return wxCommandEvent_GetSelection(wxObject);
         }
      }
      ...
      public string String {
         get {
            return new wxString(wxCommandEvent_GetString(wxObject), true);
         }
         set {
            wxCommandEvent_SetString(wxObject, value);
         }
      }
      ...
      public bool IsChecked {
         get {
            return wxCommandEvent_IsChecked(wxObject);
         }
      }
      ...
      public bool IsSelection {
         get {
            return wxCommandEvent_IsSelection(wxObject);
         }
      }
      ...
      public int Int {
         get {
            return wxCommandEvent_GetInt(wxObject);
         }
         set {
            wxCommandEvent_SetInt(wxObject, value);
         }
      }
      ...
      public ClientData ClientObject {
         get {
            return (ClientData)Object.FindObject(wxCommandEvent_GetClientObject(wxObject));
         }
         set {
            wxCommandEvent_SetClientObject(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public long ExtraLong {
         get {
            return (long)wxCommandEvent_GetExtraLong(wxObject);
         }
         set {
            wxCommandEvent_SetExtraLong(wxObject, (uint)value);
         }
      }
   }
}
