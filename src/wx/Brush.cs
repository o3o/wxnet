...
//
// $Id: Brush.cs,v 1.8 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Brush : GDIObject {
      ...
      public FillStyle Style {
         get {
            return wxBrush_GetStyle(wxObject);
         }
         set {
            wxBrush_SetStyle(wxObject, value);
         }
      }
      ...
      public Bitmap Stipple {
         get {
            return (Bitmap)FindObject(wxBrush_GetStipple(wxObject), typeof(Bitmap));
         }
         set {
      ...
      public Colour Colour {
         get {
            return new Colour(wxBrush_GetColour(wxObject), true);
         }
         set {
