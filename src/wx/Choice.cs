...
//
// $Id: Choice.cs,v 1.16 2004/12/04 14:30:38 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Choice : Control, IControlWithItems {
      ...
      public int Selection {
         ...
         set {
            wxChoice_SetSelection(wxObject, value);
         }
      }
      ...
      public string StringSelection {
         get {
            return new wxString(wxChoice_GetStringSelection(wxObject), true);
         }
         set {
            wxChoice_SetStringSelection(wxObject, value);
         }
      }
      ...
      public int Columns {
         get {
            return wxChoice_GetColumns(wxObject);
         }
         set {
            wxChoice_SetColumns(wxObject, value);
         }
      }
      ...
      public int Count {
         get {
            return wxChoice_GetCount(wxObject);
         }
      }
      ...
      public bool Empty {
         get {
            return wxChoice_IsEmpty(wxObject);
         }
      }
