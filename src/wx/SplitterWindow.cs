...
//
// $Id: SplitterWindow.cs,v 1.10 2004/11/14 14:53:29 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class SplitterWindow : Window {
      ...
      public bool IsSplit {
         get {
            return wxSplitWnd_IsSplit(wxObject);
         }
      }
      ...
      public SplitMode SplitMode {
         get {
            return (SplitMode)wxSplitWnd_GetSplitMode(wxObject);
         }
         set {
            wxSplitWnd_SetSplitMode(wxObject, (int)value);
         }
      }
      ...
      public int SashPosition {
         ...
         get {
            return wxSplitWnd_GetSashPosition(wxObject);
         }
      }
      ...
      public int MinimumPaneSize {
         get {
            return wxSplitWnd_GetMinimumPaneSize(wxObject);
         }
         set {
            wxSplitWnd_SetMinimumPaneSize(wxObject, value);
         }
      }
      ...
      public Window Window1 {
         get {
            return (Window)FindObject(wxSplitWnd_GetWindow1(wxObject), typeof(Window));
         }
      }
      ...
      public Window Window2 {
         get {
            return (Window)FindObject(wxSplitWnd_GetWindow2(wxObject), typeof(Window));
         }
      }
