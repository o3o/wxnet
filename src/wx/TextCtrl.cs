...
// $Id: TextCtrl.cs,v 1.26 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class TextAttr : Object {
      ...
      public Colour TextColour {
         set {
            wxTextAttr_SetTextColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxTextAttr_GetTextColour(wxObject), true);
         }
      }
      ...
      public Colour BackgroundColour {
         set {
            wxTextAttr_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxTextAttr_GetBackgroundColour(wxObject), true);
         }
      }
      ...
      public Font Font {
         set {
            wxTextAttr_SetFont(wxObject, Object.SafePtr(value));
         }
         get {
            return new Font(wxTextAttr_GetFont(wxObject));
         }
      }
      ...
      public TextAttrAlignment Alignment {
         set {
            wxTextAttr_SetAlignment(wxObject, (int)value);
         }
         get {
            return (TextAttrAlignment)wxTextAttr_GetAlignment(wxObject);
         }
      }
      ...
      public long LeftIndent {
         get {
            return wxTextAttr_GetLeftIndent(wxObject);
         }
      }

      public long LeftSubIndent {
         get {
            return wxTextAttr_GetLeftSubIndent(wxObject);
         }
      }
      ...
      public int RightIndent {
         set {
            wxTextAttr_SetRightIndent(wxObject, value);
         }
         get {
            return wxTextAttr_GetRightIndent(wxObject);
         }
      }
      ...
      public long Flags {
         set {
            wxTextAttr_SetFlags(wxObject, (uint)value);
         }
         get {
            return (long)wxTextAttr_GetFlags(wxObject);
         }
      }
      ...
      public bool HasTextColour {
         get {
            return wxTextAttr_HasTextColour(wxObject);
         }
      }
      ...
      public bool HasBackgroundColour {
         get {
            return wxTextAttr_HasBackgroundColour(wxObject);
         }
      }
      ...
      public bool HasFont {
         get {
            return wxTextAttr_HasFont(wxObject);
         }
      }
      ...
      public bool HasAlignment {
         get {
            return wxTextAttr_HasAlignment(wxObject);
         }
      }
      ...
      public bool HasTabs {
         get {
            return wxTextAttr_HasTabs(wxObject);
         }
      }
      ...
      public bool HasLeftIndent {
         get {
            return wxTextAttr_HasLeftIndent(wxObject);
         }
      }
      ...
      public bool HasRightIndent {
         get {
            return wxTextAttr_HasRightIndent(wxObject);
         }
      }
      ...
      public bool IsDefault {
         get {
            return wxTextAttr_IsDefault(wxObject);
         }
      }
   }
   ...
   public class TextCtrl : Control {
      ...
      public bool IsModified {
         get {
            return wxTextCtrl_IsModified(wxObject);
         }
      }

      public bool IsEditable {
         get {
            return wxTextCtrl_IsEditable(wxObject);
         }
      }

      public bool IsSingleLine {
         get {
            return wxTextCtrl_IsSingleLine(wxObject);
         }
      }

      public bool IsMultiLine {
         get {
            return wxTextCtrl_IsMultiLine(wxObject);
         }
      }
      ...
      public long MaxLength {
         set {
            wxTextCtrl_SetMaxLength(wxObject, (uint)value);
         }
      }
