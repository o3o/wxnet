...
//
// $Id: SpinCtrl.cs,v 1.11 2004/07/31 17:06:10 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class SpinCtrl : Control {
      ...
      public int Value {
         get {
            return wxSpinCtrl_GetValue(wxObject);
         }
         set {
      ...
      public int Max {
         get {
            return wxSpinCtrl_GetMax(wxObject);
         }
      }

      public int Min {
         get {
            return wxSpinCtrl_GetMin(wxObject);
         }
      }
