...
//
// $Id: VLBox.cs,v 1.5 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public abstract class VListBox : VScrolledWindow {
      ...
      public int ItemCount {
         get {
            return wxVListBox_GetItemCount(wxObject);
         }
         set {
            wxVListBox_SetItemCount(wxObject, value);
         }
      }
      ...
      public bool HasMultipleSelection {
         get {
            return wxVListBox_HasMultipleSelection(wxObject);
         }
      }
      ...
      public int Selection {
         get {
            return wxVListBox_GetSelection(wxObject);
         }
         set {
      ...
      public int SelectedCount {
         get {
            return wxVListBox_GetSelectedCount(wxObject);
         }
      }
      ...
      public Point Margins {
         ...
         set {
            wxVListBox_SetMargins(wxObject, ref value);
         }
      }
      ...
      public Colour SelectionBackground {
         get {
            return new Colour(wxVListBox_GetSelectionBackground(wxObject), true);
         }
         set {
            wxVListBox_SetSelectionBackground(wxObject, Object.SafePtr(value));
         }
      }
