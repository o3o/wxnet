...
//
// $Id: DC.cs,v 1.26 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class DC : Object {
      ...
      public FillStyle BackgroundMode {
         set {
            wxDC_SetBackgroundMode(wxObject, value);
         }
         get {
            return (FillStyle)wxDC_GetBackgroundMode(wxObject);
         }
      }
      ...
      public Brush Brush {
         set {
            wxDC_SetBrush(wxObject, Object.SafePtr(value));
         }
         get {
            return new Brush(wxDC_GetBrush(wxObject));
         }
      }

      public Brush Background {
         set {
            wxDC_SetBackground(wxObject, Object.SafePtr(value));
         }
         get {
            return new Brush(wxDC_GetBackground(wxObject));
         }
      }
      ...
      public Pen Pen {
         set {
            wxDC_SetPen(wxObject, value.wxObject);
         }
         get {
            return (Pen)FindObject(wxDC_GetPen(wxObject), typeof(Pen));
         }
      }
      ...
      public Colour TextForeground {
         get {
            return (Colour)FindObject(wxDC_GetTextForeground(wxObject), typeof(Colour));
         }
         set {
            wxDC_SetTextForeground(wxObject, Object.SafePtr(value));
         }
      }

      public Colour TextBackground {
         get {
            return (Colour)FindObject(wxDC_GetTextBackground(wxObject), typeof(Colour));
         }
         set {
            wxDC_SetTextBackground(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Font Font {
         get {
            return (Font)FindObject(wxDC_GetFont(wxObject), typeof(Font));
         }
         set {
            wxDC_SetFont(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Logic LogicalFunction {
         get {
            return (Logic)wxDC_GetLogicalFunction(wxObject);
         }
         set {
            wxDC_SetLogicalFunction(wxObject, (int)value);
         }
      }
      ...
      public int MapMode {
         get {
            return wxDC_GetMapMode(wxObject);
         }
         set {
            wxDC_SetMapMode(wxObject, value);
         }
      }
