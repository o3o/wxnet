...
namespace wx {
   ...
   public class LanguageInfo : Object {
      ...
      public int Language {
         get {
            return wxLanguageInfo_GetLanguage(wxObject);
         }
         set {
            wxLanguageInfo_SetLanguage(wxObject, value);
         }
      }
      ...
      public string CanonicalName {
         get {
            return new wxString(wxLanguageInfo_GetCanonicalName(wxObject), true);
         }
         set {
            wxLanguageInfo_SetCanonicalName(wxObject, value);
         }
      }
      ...
      public string Description {
         get {
            return new wxString(wxLanguageInfo_GetDescription(wxObject), true);
         }
         set {
            wxLanguageInfo_SetDescription(wxObject, value);
         }
      }
   }
   ...
   public class Locale : Object {
      ...
      public string CanonicalName {
         get {
            return new wxString(wxLocale_GetCanonicalName(wxObject), true);
         }
      }
      ...
      public Language Language {
         get {
            return (Language)wxLocale_GetLanguage(wxObject);
         }
      }
      ...
      public string Name {
         get {
            return new wxString(wxLocale_GetName(wxObject), true);
         }
      }
      ...
      public string SysName {
         get {
            return new wxString(wxLocale_GetSysName(wxObject), true);
         }
      }
      ...
      public static FontEncoding SystemEncoding {
         get {
            return (FontEncoding)wxLocale_GetSystemEncoding();
         }
      }
      ...
      public static string SystemEncodingName {
         get {
            return new wxString(wxLocale_GetSystemEncodingName(), true);
         }
      }
      ...
      public static Language SystemLanguage {
         get {
            return (Language)wxLocale_GetSystemLanguage();
         }
      }
