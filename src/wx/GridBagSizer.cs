...
namespace wx {
   public class GBSizerItem : SizerItem {
      ...
      public GBPosition Pos {
         get {
            return (GBPosition)FindObject(wxGBSizerItem_GetPos(wxObject), typeof(GBPosition));
         }
         set {
            wxGBSizerItem_SetPos(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public GBSpan Span {
         get {
            return (GBSpan)FindObject(wxGBSizerItem_GetSpan(wxObject), typeof(GBSpan));
         }
         set {
            wxGBSizerItem_SetSpan(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public GridBagSizer GBSizer {
         get {
            return (GridBagSizer)FindObject(wxGBSizerItem_GetGBSizer(wxObject), typeof(GBSizerItem));
         }
         set {
            wxGBSizerItem_SetGBSizer(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public class GBSpan : Object {
      ...
      public int Rowspan {
         get {
            return wxGBSpan_GetRowspan(wxObject);
         }
         set {
            wxGBSpan_SetRowspan(wxObject, value);
         }
      }
      ...
      public int Colspan {
         get {
            return wxGBSpan_GetColspan(wxObject);
         }
         set {
            wxGBSpan_SetColspan(wxObject, value);
         }
      }
   }
   ...
   public class GridBagSizer : FlexGridSizer {
      ...
      public Size EmptyCellSize {
         ...
         set {
            wxGridBagSizer_SetEmptyCellSize(wxObject, ref value);
         }
      }
