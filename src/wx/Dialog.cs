...
//
// $Id: Dialog.cs,v 1.17 2004/11/24 20:47:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Dialog : Window {
      ...
      public int ReturnCode {
         get {
            return wxDialog_GetReturnCode(wxObject);
         }
         set {
            wxDialog_SetReturnCode(wxObject, value);
         }
      }
      ...
      public override string Title {
         get {
            return new wxString(wxDialog_GetTitle(wxObject), true);
         }
         set {
            wxDialog_SetTitle(wxObject, value);
         }
      }
      ...
      public bool Modal {
         set {
            wxDialog_SetModal(wxObject, value);
         }
         get {
            return wxDialog_IsModal(wxObject);
         }
      }
   }
}
