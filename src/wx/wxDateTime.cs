...
//
// $Id: wxDateTime.cs,v 1.6 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class wxDateTime : Object {
      ...
      public ushort Year {
         get {
            return wxDateTime_GetYear(wxObject);
         }
      }

      int Month {
         get {
            return wxDateTime_GetMonth(wxObject);
         }
      }

      ushort Day {
         get {
            return wxDateTime_GetDay(wxObject);
         }
      }

      ushort Hour {
         get {
            return wxDateTime_GetHour(wxObject);
         }
      }

      ushort Minute {
         get {
            return wxDateTime_GetMinute(wxObject);
         }
      }

      ushort Second {
         get {
            return wxDateTime_GetSecond(wxObject);
         }
      }

      ushort Millisecond {
         get {
            return wxDateTime_GetMillisecond(wxObject);
         }
      }
