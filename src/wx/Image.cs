...
//
// $Id: Image.cs,v 1.16 2005/04/23 17:45:49 nummish Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Image : Object {
      ...
      public int Height {
         get {
            return wxImage_GetHeight(wxObject);
         }
      }
      ...
      public int Width {
         get {
            return wxImage_GetWidth(wxObject);
         }
      }
      ...
      public bool Mask {
         set {
            wxImage_SetMask(wxObject, value);
         }
         get {
            return wxImage_HasMask(wxObject);
         }
      }
      ...
      public byte MaskRed {
         get {
            return wxImage_GetMaskRed(wxObject);
         }
      }
      ...
      public byte MaskGreen {
         get {
            return wxImage_GetMaskGreen(wxObject);
         }
      }
      ...
      public byte MaskBlue {
         get {
            return wxImage_GetMaskBlue(wxObject);
         }
      }
      ...
      public Palette Palette {
         get {
            return (Palette)FindObject(wxImage_GetPalette(wxObject), typeof(Palette));
         }
         set {
            wxImage_SetPalette(wxObject, Object.SafePtr(value));
         }
      }
      ...
      */
      ...
      public static string ImageExtWildcard {
         get {
            return new wxString(wxImage_GetImageExtWildcard(), true);
         }
      }
   ...
   public class ImageHandler : Object {
      ...
      public string Name {
         get {
            return new wxString(wxImageHandler_GetName(wxObject), true);
         }
         set {
            wxImageHandler_SetName(wxObject, value);
         }
      }
      ...
      public string Extension {
         get {
            return new wxString(wxImageHandler_GetExtension(wxObject), true);
         }
         set {
            wxImageHandler_SetExtension(wxObject, value);
         }
      }
      ...
      public long Type {
         get {
            return (long)wxImageHandler_GetType(wxObject);
         }
         set {
            wxImageHandler_SetType(wxObject, (uint)value);
         }
      }
      ...
      public string MimeType {
         get {
            return new wxString(wxImageHandler_GetMimeType(wxObject), true);
         }
         set {
            wxImageHandler_SetMimeType(wxObject, value);
         }
      }
   }
   ...
   public class ImageHistogramEntry : Object {
      ...
      public ulong index {
         get {
            return wxImageHistogramEntry_index(wxObject);
         }
         set {
            wxImageHistogramEntry_Setindex(wxObject, value);
         }
      }
      ...
      public ulong value {
         get {
            return wxImageHistogramEntry_value(wxObject);
         }
         set {
            wxImageHistogramEntry_Setvalue(wxObject, value);
         }
      }
   }
