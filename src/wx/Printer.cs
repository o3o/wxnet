...
//
// $Id: Printer.cs,v 1.9 2004/11/24 20:47:44 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class Printer : Object {
      ...
      public PrintDialogData PrintDialogData {
         get {
            return (PrintDialogData)FindObject(wxPrinter_GetPrintDialogData(wxObject), typeof(PrintDialogData));
         }
      }
      ...
      public bool Abort {
         get {
            return wxPrinter_GetAbort(wxObject);
         }
      }
      ...
      public PrinterError LastError {
         get {
            return (PrinterError)wxPrinter_GetLastError(wxObject);
         }
      }
   ...
   public abstract class Printout : Object {
      ...
      public string Title {
         get {
            return new wxString(wxPrintout_GetTitle(wxObject), true);
         }
      }
      ...
      public DC DC {
         get {
            return (DC)FindObject(wxPrintout_GetDC(wxObject), typeof(DC));
         }
         set {
            wxPrintout_SetDC(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool IsPreview {
         get {
            return wxPrintout_IsPreview(wxObject);
         }
         set {
            wxPrintout_SetIsPreview(wxObject, value);
         }
      }
   }
}
