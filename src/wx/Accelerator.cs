...
//
// $Id: Accelerator.cs,v 1.6 2004/12/09 20:13:40 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class AcceleratorEntry : Object {
      ...
      public MenuItem MenuItem {
         set {
            wxAcceleratorEntry_SetMenuItem(wxObject, Object.SafePtr(value));
         }
         get {
            return (MenuItem)Object.FindObject(wxAcceleratorEntry_GetMenuItem(wxObject), typeof(MenuItem));
         }
      }
      ...
      public int Flags {
         get {
            return wxAcceleratorEntry_GetFlags(wxObject);
         }
      }
      ...
      public int KeyCode {
         get {
            return wxAcceleratorEntry_GetKeyCode(wxObject);
         }
      }
      ...
      public int Command {
         get {
            return wxAcceleratorEntry_GetCommand(wxObject);
         }
      }
   ...
   public class AcceleratorTable : Object {
      ...
      public bool Ok {
         get {
            return wxAcceleratorTable_Ok(wxObject);
         }
      }
   }
}
