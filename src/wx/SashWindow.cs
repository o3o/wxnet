...
//
// $Id: SashWindow.cs,v 1.5 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class SashEdge : Object {
      ...
      public bool m_show {
         get {
            return wxSashEdge_m_show(wxObject);
         }
      }
      ...
      public bool m_border {
         get {
            return wxSashEdge_m_border(wxObject);
         }
      }
      ...
      public int m_margin {
         get {
            return wxSashEdge_m_margin(wxObject);
         }
      }
   }
   ...
   public class SashWindow : Window {
      ...
      public int DefaultBorderSize {
         get {
            return wxSashWindow_GetDefaultBorderSize(wxObject);
         }
         set {
            wxSashWindow_SetDefaultBorderSize(wxObject, value);
         }
      }
      ...
      public int ExtraBorderSize {
         get {
            return wxSashWindow_GetExtraBorderSize(wxObject);
         }
         set {
            wxSashWindow_SetExtraBorderSize(wxObject, value);
         }
      }
      ...
      public int MinimumSizeX {
         get {
            return wxSashWindow_GetMinimumSizeX(wxObject);
         }
         set {
            wxSashWindow_SetMinimumSizeX(wxObject, value);
         }
      }
      ...
      public int MinimumSizeY {
         get {
            return wxSashWindow_GetMinimumSizeY(wxObject);
         }
         set {
            wxSashWindow_SetMinimumSizeY(wxObject, value);
         }
      }
      ...
      public int MaximumSizeX {
         get {
            return wxSashWindow_GetMaximumSizeX(wxObject);
         }
         set {
            wxSashWindow_SetMaximumSizeX(wxObject, value);
         }
      }
      ...
      public int MaximumSizeY {
         get {
            return wxSashWindow_GetMaximumSizeY(wxObject);
         }
         set {
            wxSashWindow_SetMaximumSizeY(wxObject, value);
         }
      }
   }
   ...
   public class SashEvent : CommandEvent {
      ...
      public SashEdgePosition Edge {
         get {
            return wxSashEvent_GetEdge(wxObject);
         }
         set {
            wxSashEvent_SetEdge(wxObject, value);
         }
      }
      ...
      public Rectangle DragRect {
         ...
         set {
            wxSashEvent_SetDragRect(wxObject, ref value);
         }
      }
      ...
      public SashDragStatus DragStatus {
         get {
            return wxSashEvent_GetDragStatus(wxObject);
         }
         set {
            wxSashEvent_SetDragStatus(wxObject, value);
         }
      }
   }
}