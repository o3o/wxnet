...
//
// $Id: TextDialog.cs,v 1.6 2004/11/24 20:47:45 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class TextEntryDialog : Dialog {
      ...
      public string Value {
         get {
            return new wxString(wxTextEntryDialog_GetValue(wxObject), true);
         }
         set {
            wxTextEntryDialog_SetValue(wxObject, value);
         }
      }
