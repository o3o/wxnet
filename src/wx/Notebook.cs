...
//
// $Id: Notebook.cs,v 1.17 2004/11/24 20:47:44 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class NotebookEvent : Event {
      ...
      public int Selection {
         get {
            return wxNotebookEvent_GetSelection(wxObject);
         }
         set {
            wxNotebookEvent_SetSelection(wxObject, value);
         }
      }
      ...
      public int OldSelection {
         get {
            return wxNotebookEvent_GetOldSelection(wxObject);
         }
         set {
            wxNotebookEvent_SetOldSelection(wxObject, value);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxNotebookEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class Notebook : Control {
      ...
      public ImageList Images {
         set {
            wxNotebook_SetImageList(wxObject, Object.SafePtr(value));
         }
         get {
            return (ImageList)FindObject(wxNotebook_GetImageList(wxObject));
         }
      }
      ...
      public int PageCount {
         get {
            return wxNotebook_GetPageCount(wxObject);
         }
      }
      ...
      public int Selection {
         get {
            return wxNotebook_GetSelection(wxObject);
         }
         set {
            wxNotebook_SetSelection(wxObject, value);
         }
      }
      ...
      public int RowCount {
         get {
            return wxNotebook_GetRowCount(wxObject);
         }
      }
      ...
      public Size PageSize {
         set {
            wxNotebook_SetPageSize(wxObject, ref value);
         }
      }

      public Size Padding {
         set {
            wxNotebook_SetPadding(wxObject, ref value);
         }
      }

      public Size TabSize {
         set {
            wxNotebook_SetTabSize(wxObject, ref value);
         }
      }
