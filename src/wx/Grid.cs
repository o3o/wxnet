...
//
// $Id: Grid.cs,v 1.17 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class GridEvent : Event {
      ...
      public int Row {
         get {
            return wxGridEvent_GetRow(wxObject);
         }
      }

      public int Col {
         get {
            return wxGridEvent_GetCol(wxObject);
         }
      }
      ...
      public bool Selecting {
         get {
            return wxGridEvent_Selecting(wxObject);
         }
      }
      ...
      public bool ControlDown {
         get {
            return wxGridEvent_ControlDown(wxObject);
         }
      }

      public bool MetaDown {
         get {
            return wxGridEvent_MetaDown(wxObject);
         }
      }

      public bool ShiftDown {
         get {
            return wxGridEvent_ShiftDown(wxObject);
         }
      }

      public bool AltDown {
         get {
            return wxGridEvent_AltDown(wxObject);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxGridEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public abstract class GridCellEditor : GridCellWorker {
      ...
      public bool IsCreated {
         get {
            return wxGridCellEditor_IsCreated(wxObject);
         }
      }
   ...
   public class GridRangeSelectEvent : Event {
      ...
      public GridCellCoords TopLeftCoords {
         get {
            return new GridCellCoords(wxGridRangeSelectEvent_GetTopLeftCoords(wxObject));
         }
      }

      public GridCellCoords BottomRightCoords {
         get {
            return new GridCellCoords(wxGridRangeSelectEvent_GetBottomRightCoords(wxObject));
         }
      }
      ...
      public int TopRow {
         get {
            return wxGridRangeSelectEvent_GetTopRow(wxObject);
         }
      }

      public int BottomRow {
         get {
            return wxGridRangeSelectEvent_GetBottomRow(wxObject);
         }
      }
      ...
      public int LeftCol {
         get {
            return wxGridRangeSelectEvent_GetLeftCol(wxObject);
         }
      }

      public int RightCol {
         get {
            return wxGridRangeSelectEvent_GetRightCol(wxObject);
         }
      }
      ...
      public bool Selecting {
         get {
            return wxGridRangeSelectEvent_Selecting(wxObject);
         }
      }
      ...
      public bool ControlDown {
         get {
            return wxGridRangeSelectEvent_ControlDown(wxObject);
         }
      }

      public bool MetaDown {
         get {
            return wxGridRangeSelectEvent_MetaDown(wxObject);
         }
      }

      public bool ShiftDown {
         get {
            return wxGridRangeSelectEvent_ShiftDown(wxObject);
         }
      }

      public bool AltDown {
         get {
            return wxGridRangeSelectEvent_AltDown(wxObject);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxGridRangeSelectEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class GridEditorCreatedEvent : CommandEvent {
      ...
      public int Row {
         get {
            return wxGridEditorCreatedEvent_GetRow(wxObject);
         }
         set {
            wxGridEditorCreatedEvent_SetRow(wxObject, value);
         }
      }
      ...
      public int Col {
         get {
            return wxGridEditorCreatedEvent_GetCol(wxObject);
         }
         set {
            wxGridEditorCreatedEvent_SetCol(wxObject, value);
         }
      }
      ...
      public Control Control {
         get {
            return (Control)FindObject(wxGridEditorCreatedEvent_GetControl(wxObject), typeof(Control));
         }
         set {
            wxGridEditorCreatedEvent_SetControl(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public class Grid : ScrolledWindow {
      ...
      public GridSelectionMode SelectionMode {
         set {
            wxGrid_SetSelectionMode(wxObject, (int)value);
         }
      ...
      public int NumberRows {
         get {
            return wxGrid_GetNumberRows(wxObject);
         }
      }

      public int NumberCols {
         get {
            return wxGrid_GetNumberCols(wxObject);
         }
      }
      ...
      public GridTableBase Table {
         get {
            return (GridTableBase)FindObject(wxGrid_GetTable(wxObject), typeof(GridTableBase));
         }
      }
      ...
      public int BatchCount {
         get {
            return wxGrid_GetBatchCount(wxObject);
         }
      }
      ...
      public bool IsEditable {
         get {
            return wxGrid_IsEditable(wxObject);
         }
         set {
            wxGrid_EnableEditing(wxObject, value);
         }
      }
      ...
      public bool CellEditControlEnabled {
         set {
            wxGrid_EnableCellEditControl(wxObject, value);
         }
         get {
            return wxGrid_IsCellEditControlEnabled(wxObject);
         }
      }
      ...
      public bool CanEnableCellControl {
         get {
            return wxGrid_CanEnableCellControl(wxObject);
         }
      }
      ...
      public bool IsCellEditControlShown {
         get {
            return wxGrid_IsCellEditControlShown(wxObject);
         }
      }

      public bool IsCurrentCellReadOnly {
         get {
            return wxGrid_IsCurrentCellReadOnly(wxObject);
         }
      }
      ...
      public int GridCursorRow {
         get {
            return wxGrid_GetGridCursorRow(wxObject);
         }
      }

      public int GridCursorCol {
         get {
            return wxGrid_GetGridCursorCol(wxObject);
         }
      }
      ...
      public int DefaultRowLabelSize {
         get {
            return wxGrid_GetDefaultRowLabelSize(wxObject);
         }
      }

      public int RowLabelSize {
         get {
            return wxGrid_GetRowLabelSize(wxObject);
         }
         set {
            wxGrid_SetRowLabelSize(wxObject, value);
         }
      }
      ...
      public int DefaultColLabelSize {
         get {
            return wxGrid_GetDefaultColLabelSize(wxObject);
         }
      }

      public int ColLabelSize {
         get {
            return wxGrid_GetColLabelSize(wxObject);
         }
         set {
            wxGrid_SetColLabelSize(wxObject, value);
         }
      }
      ...
      public Colour LabelBackgroundColour {
         get {
            return new Colour(wxGrid_GetLabelBackgroundColour(wxObject), true);
         }
         set {
            wxGrid_SetLabelBackgroundColour(wxObject, Object.SafePtr(value));
         }
      }

      public Colour LabelTextColour {
         get {
            return new Colour(wxGrid_GetLabelTextColour(wxObject), true);
         }
         set {
            wxGrid_SetLabelTextColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Font LabelFont {
         get {
            return new Font(wxGrid_GetLabelFont(wxObject));
         }
         set {
            wxGrid_SetLabelFont(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour GridLineColour {
         get {
            return new Colour(wxGrid_GetGridLineColour(wxObject), true);
         }
         set {
            wxGrid_SetGridLineColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour CellHighlightColour {
         get {
            return new Colour(wxGrid_GetCellHighlightColour(wxObject), true);
         }
         set {
            wxGrid_SetCellHighlightColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int CellHighlightPenWidth {
         get {
            return wxGrid_GetCellHighlightPenWidth(wxObject);
         }
         set {
            wxGrid_SetCellHighlightPenWidth(wxObject, value);
         }
      }
      ...
      public int CellHighlightROPenWidth {
         get {
            return wxGrid_GetCellHighlightROPenWidth(wxObject);
         }
         set {
            wxGrid_SetCellHighlightROPenWidth(wxObject, value);
         }
      }
      ...
      public bool DragRowSizeEnabled {
         set {
            wxGrid_EnableDragRowSize(wxObject, value);
         }
         get {
            return wxGrid_CanDragRowSize(wxObject);
         }
      }
      ...
      public bool DragColSizeEnabled {
         set {
            wxGrid_EnableDragColSize(wxObject, value);
         }
         get {
            return wxGrid_CanDragColSize(wxObject);
         }
      }
      ...
      public bool DragGridSizeEnabled {
         set {
            wxGrid_EnableDragGridSize(wxObject, value);
         }
         get {
            return wxGrid_CanDragGridSize(wxObject);
         }
      }
      ...
      public int ColFormatBool {
         set {
            wxGrid_SetColFormatBool(wxObject, value);
         }
      }

      public int ColFormatNumber {
         set {
            wxGrid_SetColFormatNumber(wxObject, value);
         }
      }
      ...
      public bool GridLinesEnabled {
         set {
            wxGrid_EnableGridLines(wxObject, value);
         }
         get {
            return wxGrid_GridLinesEnabled(wxObject);
         }
      }
      ...
      public int DefaultRowSize {
         get {
            return wxGrid_GetDefaultRowSize(wxObject);
         }
      }
      ...
      public int DefaultColSize {
         get {
            return wxGrid_GetDefaultColSize(wxObject);
         }
      }
      ...
      public Colour DefaultCellBackgroundColour {
         get {
            return new Colour(wxGrid_GetDefaultCellBackgroundColour(wxObject), true);
         }
         set {
            wxGrid_SetDefaultCellBackgroundColour(wxObject, Object.SafePtr(value));
         }
      }

      public Colour DefaultCellTextColour {
         get {
            return new Colour(wxGrid_GetDefaultCellTextColour(wxObject), true);
         }
         set {
            wxGrid_SetDefaultCellTextColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Font DefaultCellFont {
         get {
            return new Font(wxGrid_GetDefaultCellFont(wxObject));
         }
         set {
            wxGrid_SetDefaultCellFont(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool DefaultCellOverflow {
         get {
            return wxGrid_GetDefaultCellOverflow(wxObject);
         }
         set {
            wxGrid_SetDefaultCellOverflow(wxObject, value);
         }
      }
      ...
      public int ColMinimalAcceptableWidth {
         set {
            wxGrid_SetColMinimalAcceptableWidth(wxObject, value);
         }
         get {
            return wxGrid_GetColMinimalAcceptableWidth(wxObject);
         }
      }

      public int RowMinimalAcceptableHeight {
         set {
            wxGrid_SetRowMinimalAcceptableHeight(wxObject, value);
         }
         get {
            return wxGrid_GetRowMinimalAcceptableHeight(wxObject);
         }
      }
      ...
      public GridCellRenderer DefaultRenderer {
         set {
            wxGrid_SetDefaultRenderer(wxObject, Object.SafePtr(value));
         }
      ...
      public GridCellEditor DefaultEditor {
         set {
            wxGrid_SetDefaultEditor(wxObject, Object.SafePtr(value));
         }
         get {
            return (GridCellEditor)Object.FindObject(wxGrid_GetDefaultEditor(wxObject), typeof(GridCellEditor));
         }
      }
      ...
      public bool IsSelection {
         get {
            return wxGrid_IsSelection(wxObject);
         }
      }
      ...
      public Colour SelectionBackground {
         get {
            return new Colour(wxGrid_GetSelectionBackground(wxObject), true);
         }
         set {
            wxGrid_SetSelectionBackground(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour SelectionForeground {
         get {
            return new Colour(wxGrid_GetSelectionForeground(wxObject), true);
         }
         set {
            wxGrid_SetSelectionForeground(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Window GridWindow {
         get {
            return (Window)FindObject(wxGrid_GetGridWindow(wxObject));
         }
      }

      public Window GridRowLabelWindow {
         get {
            return (Window)FindObject(wxGrid_GetGridRowLabelWindow(wxObject));
         }
      }

      public Window GridColLabelWindow {
         get {
            return (Window)FindObject(wxGrid_GetGridColLabelWindow(wxObject));
         }
      }

      public Window GridCornerLabelWindow {
         get {
            return (Window)FindObject(wxGrid_GetGridCornerLabelWindow(wxObject));
         }
      }
      ...
      public int Rows {
         get {
            return wxGrid_GetRows(wxObject);
         }
      }

      public int Cols {
         get {
            return wxGrid_GetCols(wxObject);
         }
      }
      ...
      public int CursorRow {
         get {
            return wxGrid_GetCursorRow(wxObject);
         }
      }

      public int CursorColumn {
         get {
            return wxGrid_GetCursorColumn(wxObject);
         }
      }
      ...
      public int ScrollPosX {
         get {
            return wxGrid_GetScrollPosX(wxObject);
         }
         set {
            wxGrid_SetScrollX(wxObject, value);
         }
      }

      public int ScrollPosY {
         get {
            return wxGrid_GetScrollPosY(wxObject);
         }
         set {
            wxGrid_SetScrollY(wxObject, value);
         }
      }
      ...
      public int ViewHeight {
         get {
            return wxGrid_GetViewHeight(wxObject);
         }
      }

      public int ViewWidth {
         get {
            return wxGrid_GetViewWidth(wxObject);
         }
      }
      ...
      public Font CellTextFont {
         get {
            return new Font(wxGrid_GetCellTextFontGrid(wxObject));
         }
         set {
            wxGrid_SetCellTextFontGrid(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour CellTextColour {
         set {
            wxGrid_SetCellTextColourGrid(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour CellBackgroundColour {
         set {
            wxGrid_SetCellBackgroundColourGrid(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool Editable {
         get {
            return wxGrid_GetEditable(wxObject);
         }
         set {
            wxGrid_SetEditable(wxObject, value);
         }
      }
      ...
      public bool EditInPlace {
         get {
            return wxGrid_GetEditInPlace(wxObject);
         }
      }
      ...
      public int CellAlignment {
         set {
            wxGrid_SetCellAlignmentGrid(wxObject, value);
         }
      }
      ...
      public Pen DividerPen {
         set {
            wxGrid_SetDividerPen(wxObject, Object.SafePtr(value));
         }
         get {
            return new Pen(wxGrid_GetDividerPen(wxObject));
         }
      }
      ...
      public event EventListener CellLeftClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_CELL_LEFT_CLICK, ID, value, this);
         }
         remove {
      ...
      public event EventListener CellRightClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_CELL_RIGHT_CLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener CellLeftDoubleClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_CELL_LEFT_DCLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener CellRightDoubleClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_CELL_RIGHT_DCLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener LabelLeftClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_LABEL_LEFT_CLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener LabelRightClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_LABEL_RIGHT_CLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener LabelLeftDoubleClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_LABEL_LEFT_DCLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener LabelRightDoubleClick {
         add {
            AddCommandListener(Event.wxEVT_GRID_LABEL_RIGHT_DCLICK, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener RowSize {
         add {
            AddCommandListener(Event.wxEVT_GRID_ROW_SIZE, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener ColumnSize {
         add {
            AddCommandListener(Event.wxEVT_GRID_COL_SIZE, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener RangeSelect {
         add {
            AddCommandListener(Event.wxEVT_GRID_RANGE_SELECT, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener CellChange {
         add {
            AddCommandListener(Event.wxEVT_GRID_CELL_CHANGE, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener SelectCell {
         add {
            AddCommandListener(Event.wxEVT_GRID_SELECT_CELL, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener EditorShown {
         add {
            AddCommandListener(Event.wxEVT_GRID_EDITOR_SHOWN, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener EditorHidden {
         add {
            AddCommandListener(Event.wxEVT_GRID_EDITOR_HIDDEN, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
      ...
      public event EventListener EditorCreate {
         add {
            AddCommandListener(Event.wxEVT_GRID_EDITOR_CREATED, ID, value, this);
         }
         remove {
            RemoveHandler(value, this);
         }
   ...
   public class GridCellCoords : Object {
      ...
      public int Row {
         set {
            wxGridCellCoords_SetRow(wxObject, value);
         }
         get {
            return wxGridCellCoords_GetRow(wxObject);
         }
      }
      ...
      public int Col {
         set {
            wxGridCellCoords_SetCol(wxObject, value);
         }
         get {
            return wxGridCellCoords_GetCol(wxObject);
         }
      }
   ...
   public class GridCellAttr : Object {
      ...
      public Colour TextColour {
         set {
            wxGridCellAttr_SetTextColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxGridCellAttr_GetTextColour(wxObject), true);
         }
      }
      ...
      public Colour BackgroundColour {
         set {
            wxGridCellAttr_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
         get {
            return new Colour(wxGridCellAttr_GetBackgroundColour(wxObject), true);
         }
      }
      ...
      public Font Font {
         set {
            wxGridCellAttr_SetFont(wxObject, Object.SafePtr(value));
         }
         get {
            return new Font(wxGridCellAttr_GetFont(wxObject));
         }
      }
      ...
      public bool Overflow {
         set {
            wxGridCellAttr_SetOverflow(wxObject, value);
         }
         get {
            return wxGridCellAttr_GetOverflow(wxObject);
         }
      }
      ...
      public bool ReadOnly {
         set {
            wxGridCellAttr_SetReadOnly(wxObject, value);
         }
         get {
            return wxGridCellAttr_IsReadOnly(wxObject);
         }
      }
      ...
      public GridCellEditor Editor {
         set {
            wxGridCellAttr_SetEditor(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool HasTextColour {
         get {
            return wxGridCellAttr_HasTextColour(wxObject);
         }
      }

      public bool HasBackgroundColour {
         get {
            return wxGridCellAttr_HasBackgroundColour(wxObject);
         }
      }

      public bool HasFont {
         get {
            return wxGridCellAttr_HasFont(wxObject);
         }
      }

      public bool HasAlignment {
         get {
            return wxGridCellAttr_HasAlignment(wxObject);
         }
      }

      public bool HasRenderer {
         get {
            return wxGridCellAttr_HasRenderer(wxObject);
         }
      }

      public bool HasEditor {
         get {
            return wxGridCellAttr_HasEditor(wxObject);
         }
      }

      public bool HasReadWriteMode {
         get {
            return wxGridCellAttr_HasReadWriteMode(wxObject);
         }
      }
      ...
      public GridCellAttr DefAttr {
         set {
            wxGridCellAttr_SetDefAttr(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public class GridSizeEvent : Event {
      ...
      public int RowOrCol {
         get {
            return wxGridSizeEvent_GetRowOrCol(wxObject);
         }
      }
      ...
      public bool ControlDown {
         get {
            return wxGridSizeEvent_ControlDown(wxObject);
         }
      }

      public bool MetaDown {
         get {
            return wxGridSizeEvent_MetaDown(wxObject);
         }
      }

      public bool ShiftDown {
         get {
            return wxGridSizeEvent_ShiftDown(wxObject);
         }
      }

      public bool AltDown {
         get {
            return wxGridSizeEvent_AltDown(wxObject);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxGridSizeEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class GridCellFloatRenderer : GridCellStringRenderer {
      ...
      public int Width {
         get {
            return wxGridCellFloatRenderer_GetWidth(wxObject);
         }
         set {
            wxGridCellFloatRenderer_SetWidth(wxObject,value);
         }
      }

      public int Precision {
         get {
            return wxGridCellFloatRenderer_GetPrecision(wxObject);
         }
         set {
            wxGridCellFloatRenderer_SetPrecision(wxObject, value);
         }
      }
