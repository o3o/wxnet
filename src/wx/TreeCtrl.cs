...
//
// $Id: TreeCtrl.cs,v 1.33 2004/12/09 20:13:41 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class TreeItemData : ClientData {
      ...
      public TreeItemId Id {
         get {
            return new TreeItemId(wxTreeItemData_GetId(wxObject), true);
         }
         set {
            wxTreeItemData_SetId(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public class TreeItemAttr : Object {
      ...
      public Colour TextColour {
         get {
            return new Colour(wxTreeItemAttr_GetTextColour(wxObject), true);
         }
         set {
            wxTreeItemAttr_SetTextColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Colour BackgroundColour {
         get {
            return new Colour(wxTreeItemAttr_GetBackgroundColour(wxObject), true);
         }
         set {
            wxTreeItemAttr_SetBackgroundColour(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Font Font {
         get {
            return new Font(wxTreeItemAttr_GetFont(wxObject), true);
         }
         set {
            wxTreeItemAttr_SetFont(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool HasTextColour {
         get {
            return wxTreeItemAttr_HasTextColour(wxObject);
         }
      }
      ...
      public bool HasBackgroundColour {
         get {
            return wxTreeItemAttr_HasBackgroundColour(wxObject);
         }
      }
      ...
      public bool HasFont {
         get {
            return wxTreeItemAttr_HasFont(wxObject);
         }
      }
   }
   ...
   public class TreeCtrl : Control {
      ...
      public ImageList ImageList {
         get {
            return (ImageList)FindObject(wxTreeCtrl_GetImageList(wxObject), typeof(ImageList));
         }

         set {
            wxTreeCtrl_SetImageList(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public ImageList StateImageList {
         get {
            return (ImageList)FindObject(wxTreeCtrl_GetStateImageList(wxObject), typeof(ImageList));
         }

         set {
            wxTreeCtrl_SetStateImageList(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public TreeItemId Selection {
         get {
            return new TreeItemId(wxTreeCtrl_GetSelection(wxObject), true);
         }
         set {
            SelectItem(value);
         }
      ...
      public TreeItemId RootItem {
         get {
            return new TreeItemId(wxTreeCtrl_GetRootItem(wxObject), true);
         }
      }
      ...
      public int Count {
         get {
            return wxTreeCtrl_GetCount(wxObject);
         }
      }
      ...
      public uint Indent {
         get {
            return wxTreeCtrl_GetIndent(wxObject);
         }
         set {
            wxTreeCtrl_SetIndent(wxObject, value);
         }
      }
      ...
      public uint Spacing {
         get {
            return wxTreeCtrl_GetSpacing(wxObject);
         }
         set {
            wxTreeCtrl_SetSpacing(wxObject, value);
         }
      }
   ...
   public class TreeEvent : Event {
      ...
      public TreeItemId Item {
         get {
            return new TreeItemId(wxTreeEvent_GetItem(wxObject), true);
         }
         set {
            wxTreeEvent_SetItem(wxObject, Object.SafePtr(value));
         }
      }

      public TreeItemId OldItem {
         get {
            return new TreeItemId(wxTreeEvent_GetOldItem(wxObject), true);
         }
         set {
            wxTreeEvent_SetOldItem(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Point Point {
         ...
         set {
            wxTreeEvent_SetPoint(wxObject, ref value);
         }
      }
      ...
      public KeyEvent KeyEvent {
         get {
            return (KeyEvent)FindObject(wxTreeEvent_GetKeyEvent(wxObject), typeof(KeyEvent));
         }
         set {
            wxTreeEvent_SetKeyEvent(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public int KeyCode {
         get {
            return wxTreeEvent_GetKeyCode(wxObject);
         }
      }
      ...
      public string Label {
         ...
         set {
            wxTreeEvent_SetLabel(wxObject, value);
         }
      }
      ...
      public bool IsEditCancelled {
         get {
            return wxTreeEvent_IsEditCancelled(wxObject);
         }
         set {
            wxTreeEvent_SetEditCanceled(wxObject, value);
         }
      }

      public string ToolTip {
         set {
            wxTreeEvent_SetToolTip(wxObject, value);
         }
      }
      ...
      public bool Allowed {
         get {
            return  wxTreeEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class ArrayTreeItemIds : Object {
      ...
      public int Count {
         get {
            return wxArrayTreeItemIds_GetCount(wxObject);
         }
      }
