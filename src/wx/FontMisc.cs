...
//
// $Id: FontMisc.cs,v 1.9 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class FontEnumerator : Object {
      ...
      public string[] Facenames {
         get {
            return new ArrayString(wxFontEnumerator_GetFacenames(wxObject), true);
         }
      }
      ...
      public string[] Encodings {
         get {
            return new ArrayString(wxFontEnumerator_GetEncodings(wxObject), true);
         }
      }
