...
//
// $Id: StatusBar.cs,v 1.8 2004/11/24 20:47:44 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class StatusBar : Window {
      ...
      public int FieldsCount {
         get {
            return wxStatusBar_GetFieldsCount(wxObject);
         }
      }
      ...
      public int BorderY {
         get {
            return wxStatusBar_GetBorderY(wxObject);
         }
      }

      public int BorderX {
         get {
            return wxStatusBar_GetBorderX(wxObject);
         }
      }
      ...
      public new int MinHeight {
         set {
            wxStatusBar_SetMinHeight(wxObject, value);
         }
      }
      ...
      public int[] StatusStyles {
         set {
            wxStatusBar_SetStatusStyles(wxObject, value.Length, value);
         }
      }
   }
}
