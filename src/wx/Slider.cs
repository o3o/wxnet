...
// $Id: Slider.cs,v 1.11 2004/07/31 17:06:11 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Slider : Control {
      ...
      public int Value {
         get {
            return wxSlider_GetValue(wxObject);
         }
         set {
            wxSlider_SetValue(wxObject, value);
         }
      }
      ...
      public int Max {
         get {
            return wxSlider_GetMax(wxObject);
         }
      }

      public int Min {
         get {
            return wxSlider_GetMin(wxObject);
         }
      }
      ...
      public int LineSize {
         get {
            return wxSlider_GetLineSize(wxObject);
         }
         set {
            wxSlider_SetLineSize(wxObject, value);
         }
      }
      ...
      public int PageSize {
         get {
            return wxSlider_GetPageSize(wxObject);
         }
         set {
            wxSlider_SetPageSize(wxObject, value);
         }
      }
      ...
      public int ThumbLength {
         get {
            return wxSlider_GetThumbLength(wxObject);
         }
         set {
            wxSlider_SetThumbLength(wxObject, value);
         }
      }
      ...
      public int TickFreq {
         get {
            return wxSlider_GetTickFreq(wxObject);
         }
      }
      ...
      public int SelEnd {
         get {
            return wxSlider_GetSelEnd(wxObject);
         }
      }

      public int SelStart {
         get {
            return wxSlider_GetSelStart(wxObject);
         }
      }
