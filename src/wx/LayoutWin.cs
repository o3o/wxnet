...
//
// $Id: LayoutWin.cs,v 1.4 2004/07/31 17:06:10 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class SashLayoutWindow : SashWindow {
      ...
      public LayoutAlignment Alignment {
         get {
            return wxSashLayoutWindow_GetAlignment(wxObject);
         }
         set {
            wxSashLayoutWindow_SetAlignment(wxObject, value);
         }
      }
      ...
      public LayoutOrientation Orientation {
         get {
            return wxSashLayoutWindow_GetOrientation(wxObject);
         }
         set {
            wxSashLayoutWindow_SetOrientation(wxObject, value);
         }
      }
      ...
      public Size DefaultSize {
         set {
            wxSashLayoutWindow_SetDefaultSize(wxObject, ref value);
         }
      }
   }
   ...
   public class QueryLayoutInfoEvent : Event {
      ...
      public int RequestedLength {
         get {
            return wxQueryLayoutInfoEvent_GetRequestedLength(wxObject);
         }
         set {
            wxQueryLayoutInfoEvent_SetRequestedLength(wxObject, value);
         }
      }
      ...
      public int Flags {
         get {
            return wxQueryLayoutInfoEvent_GetFlags(wxObject);
         }
         set {
            wxQueryLayoutInfoEvent_SetFlags(wxObject, value);
         }
      }
      ...
      public Size Size {
         ...
         set {
            wxQueryLayoutInfoEvent_SetSize(wxObject, ref value);
         }
      }
      ...
      public LayoutOrientation Orientation {
         get {
            return wxQueryLayoutInfoEvent_GetOrientation(wxObject);
         }
         set {
            wxQueryLayoutInfoEvent_SetOrientation(wxObject, value);
         }
      }
      ...
      public LayoutAlignment Alignment {
         get {
            return wxQueryLayoutInfoEvent_GetAlignment(wxObject);
         }
         set {
            wxQueryLayoutInfoEvent_SetAlignment(wxObject, value);
         }
      }
   }
   ...
   public class CalculateLayoutEvent : Event {
      ...
      public int Flags {
         get {
            return wxCalculateLayoutEvent_GetFlags(wxObject);
         }
         set {
            wxCalculateLayoutEvent_SetFlags(wxObject, value);
         }
      }
      ...
      public Rectangle Rect {
         ...
         set {
            wxCalculateLayoutEvent_SetRect(wxObject, ref value);
         }
      }
   }
}