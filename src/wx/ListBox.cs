...
//
// $Id: ListBox.cs,v 1.26 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class ListBox : Control {
      ...
      public int Selection {
         get {
            return wxListBox_GetSelection(wxObject);
         }
         set {
            wxListBox_Select(wxObject, value);
         }
      }
      ...
      public string StringSelection {
         get {
            return new wxString(wxListBox_GetStringSelection(wxObject), true);
         }
         set {
            wxListBox_SetStringSelection(wxObject, value, true);
         }
      }
      ...
      public bool Sorted {
         get {
            return wxListBox_IsSorted(wxObject);
         }
      }
      ...
      public int[] Selections {
         get {
            return new ArrayInt(wxListBox_GetSelections(wxObject), true);
         }
      }
      ...
      public int Count {
         get {
            return wxListBox_GetCount(wxObject);
         }
      }
