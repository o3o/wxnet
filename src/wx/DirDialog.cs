...
//
// $Id: DirDialog.cs,v 1.6 2004/11/24 20:47:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class DirDialog : Dialog {
      ...
      public string Path {
         set {
            wxDirDialog_SetPath(wxObject, value);
         }
         get {
            return new wxString(wxDirDialog_GetPath(wxObject), true);
         }
      }
      ...
      public string Message {
         set {
            wxDirDialog_SetMessage(wxObject, value);
         }
         get {
            return new wxString(wxDirDialog_GetMessage(wxObject), true);
         }
      }
      ...
      public int Style {
         set {
            wxDirDialog_SetStyle(wxObject, value);
         }
         get {
            return wxDirDialog_GetStyle(wxObject);
         }
      }
