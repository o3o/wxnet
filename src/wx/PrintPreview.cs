...
//
// $Id: PrintPreview.cs,v 1.5 2004/06/10 16:35:19 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class PrintPreview : Object {
      ...
      public int CurrentPage {
         get {
            return wxPrintPreview_GetCurrentPage(wxObject);
         }
         set {
      ...
      public Printout Printout {
         set {
            wxPrintPreview_SetPrintout(wxObject, Object.SafePtr(value));
         }
         get {
            return (Printout)FindObject(wxPrintPreview_GetPrintout(wxObject), typeof(Printout));
         }
      }
      ...
      public Printout PrintoutForPrinting {
         get {
            return (Printout)FindObject(wxPrintPreview_GetPrintoutForPrinting(wxObject), typeof(Printout));
         }
      }
      ...
      public Frame Frame {
         set {
            wxPrintPreview_SetFrame(wxObject, Object.SafePtr(value));
         }
         get {
            return (Frame)FindObject(wxPrintPreview_GetFrame(wxObject), typeof(Frame));
         }
      }
      ...
      public Window Canvas {
         get {
            return (Window)FindObject(wxPrintPreview_GetCanvas(wxObject), typeof(Window));
         }
         set {
            wxPrintPreview_SetCanvas(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public PrintDialogData PrintDialogData {
         get {
            return (PrintDialogData)FindObject(wxPrintPreview_GetPrintDialogData(wxObject), typeof(PrintDialogData));
         }
      }
      ...
      public int Zoom {
         set {
            wxPrintPreview_SetZoom(wxObject, value);
         }
         get {
            return wxPrintPreview_GetZoom(wxObject);
         }
      }
      ...
      public int MaxPage {
         get {
            return wxPrintPreview_GetMaxPage(wxObject);
         }
      }

      public int MinPage {
         get {
            return wxPrintPreview_GetMinPage(wxObject);
         }
      }
      ...
      public bool Ok {
         get {
            return wxPrintPreview_Ok(wxObject);
         }
         set {
            wxPrintPreview_SetOk(wxObject, value);
         }
      }
   ...
   public class PreviewControlBar : Panel {
      ...
      public int ZoomControl {
         get {
            return wxPreviewControlBar_GetZoomControl(wxObject);
         }
         set {
            wxPreviewControlBar_SetZoomControl(wxObject, value);
         }
      }
      ...
      public PrintPreview PrintPreview {
         get {
            return (PrintPreview)FindObject(wxPreviewControlBar_GetPrintPreview(wxObject), typeof(PrintPreview));
         }
      }
   }
