...
//
// $Id: Frame.cs,v 1.22 2004/12/06 17:00:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Frame : Window {
      ...
      public bool IsFullScreen {
         get {
            return wxFrame_IsFullScreen(wxObject);
         }
      }
      ...
      public StatusBar StatusBar {
         get {
            return (StatusBar)FindObject(wxFrame_GetStatusBar(wxObject), typeof(StatusBar));
         }
         set {
            wxFrame_SetStatusBar(wxObject, Object.SafePtr(value));
         }
      }

      public int StatusBarPane {
         get {
            return wxFrame_GetStatusBarPane(wxObject);
         }
         set {
            wxFrame_SetStatusBarPane(wxObject, value);
         }
      }
      ...
      public MenuBar MenuBar {
         ...
         get {
            return (MenuBar)FindObject(wxFrame_GetMenuBar(wxObject), typeof(MenuBar));
         }
      }
      ...
      public ToolBar ToolBar {
         get {
            return (ToolBar)FindObject(wxFrame_GetToolBar(wxObject));
         }
         set {
            wxFrame_SetToolBar(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public bool Iconized {
         get {
            return wxFrame_IsIconized(wxObject);
         }
         set {
            wxFrame_Iconize(wxObject, value);
         }
      }
      ...
      public bool Maximized {
         get {
            return wxFrame_IsMaximized(wxObject);
         }
         set {
            wxFrame_Maximize(wxObject, value);
         }
      }
