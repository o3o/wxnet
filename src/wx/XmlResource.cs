...
//
// $Id: XmlResource.cs,v 1.13 2005/05/01 22:15:29 nummish Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class XmlResource : Object {
      ...
      public long Version {
         get {
            return wxXmlResource_GetVersion(wxObject);
         }
      }
      ...
      public XmlResourceFlags Flags {
         set {
            wxXmlResource_SetFlags(wxObject, (int)value);
         }
         get {
            return (XmlResourceFlags)wxXmlResource_GetFlags(wxObject);
         }
      }
