...
//
// $Id: PrintDialog.cs,v 1.5 2004/02/28 03:13:40 malenfant Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class PageSetupDialog : Dialog {
      ...
      public PageSetupDialogData PageSetupData {
         get {
            return (PageSetupDialogData)FindObject(wxPageSetupDialog_GetPageSetupData(wxObject), typeof(PageSetupDialogData));
         }
      }
   }
   ...
   public class PrintDialog : Dialog {
      ...
      public PrintData PrintData {
         get {
            return (PrintData)FindObject(wxPrintDialog_GetPrintData(wxObject), typeof(PrintData));
         }
      }
      ...
      public PrintDialogData PrintDialogData {
         get {
            return (PrintDialogData)FindObject(wxPrintDialog_GetPrintDialogData(wxObject), typeof(PrintDialogData));
         }
      }
      ...
      public DC PrintDC {
         get {
            return (DC)FindObject(wxPrintDialog_GetPrintDC(wxObject), typeof(DC));
         }
      }
   }
   ...
   public class PrintSetupDialog : Dialog {
      ...
      public PrintData PrintData {
         get {
            return (PrintData)FindObject(wxPrintSetupDialog_GetPrintData(wxObject), typeof(PrintData));
         }
      }
   }
