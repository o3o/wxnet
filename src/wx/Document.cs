...
namespace wx {
   public class Document : EvtHandler {
      ...
      public string Filename {
         ...
         get {
            return new wxString(wxDocument_GetFilename(wxObject), true);
         }
      }
      ...
      public string Title {
         set {
            wxDocument_SetTitle(wxObject, value);
         }
         get {
            return new wxString(wxDocument_GetTitle(wxObject), true);
         }
      }

      public string DocumentName {
         set {
            wxDocument_SetDocumentName(wxObject, value);
         }
         get {
            return new wxString(wxDocument_GetDocumentName(wxObject), true);
         }
      }
      ...
      public bool DocumentSaved {
         get {
            return wxDocument_GetDocumentSaved(wxObject);
         }
         set {
            wxDocument_SetDocumentSaved(wxObject, value);
         }
      }
      ...
      public bool IsModified {
         get {
            return wxDocument_IsModified(wxObject);
         }
         set {
            Modify(value);
         }
      ...
      public Window DocumentWindow {
         get {
            return (Window)FindObject(wxDocument_GetDocumentWindow(wxObject));
         }
      }
   }
}
