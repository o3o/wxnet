...
//
// $Id: DND.cs,v 1.16 2004/11/26 21:39:51 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class DropSource : Object {
      ...
      public DataObject DataObject {
         ...
         set {
            m_dataObject = value;
            wxDropSource_SetData(wxObject, Object.SafePtr(value));
         }
      }
   }
   ...
   public abstract class DropTarget : Object {
      ...
      public DataObject DataObject {
         ...
         set {
            m_dataObject = value;
            wxDropTarget_SetDataObject(wxObject, Object.SafePtr(value));
         }
      }
   }
