...
// $Id: Region.cs,v 1.9 2004/11/26 21:39:52 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   ...
   public class Region : GDIObject {
      ...
      public bool IsEmpty {
         get {
            return wxRegion_IsEmpty(wxObject);
         }
      }
   ...
   public class RegionIterator : Object {
      ...
      public int X {
         get {
            return wxRegionIterator_GetX(wxObject);
         }
      }

      public int Y {
         get {
            return wxRegionIterator_GetY(wxObject);
         }
      }
      ...
      public int Width {
         get {
            return wxRegionIterator_GetWidth(wxObject);
         }
      }

      public int Height {
         get {
            return wxRegionIterator_GetHeight(wxObject);
         }
      }
