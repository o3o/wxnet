...
//
// $Id: Listbook.cs,v 1.7 2004/11/24 20:47:43 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class ListbookEvent : Event {
      ...
      public int Selection {
         get {
            return wxListbookEvent_GetSelection(wxObject);
         }
         set {
            wxListbookEvent_SetSelection(wxObject, value);
         }
      }
      ...
      public int OldSelection {
         get {
            return wxListbookEvent_GetOldSelection(wxObject);
         }
         set {
            wxListbookEvent_SetOldSelection(wxObject, value);
         }
      }
      ...
      public bool Allowed {
         get {
            return wxListbookEvent_IsAllowed(wxObject);
         }
      }
   }
   ...
   public class Listbook : Control {
      ...
      public int Selection {
         get {
            return wxListbook_GetSelection(wxObject);
         }
         set {
            wxListbook_SetSelection(wxObject, value);
         }
      }
      ...
      public ImageList ImageList {
         set {
            wxListbook_SetImageList(wxObject, Object.SafePtr(value));
         }
         get {
            return (ImageList)FindObject(wxListbook_GetImageList(wxObject), typeof(ImageList));
         }
      }
      ...
      public bool Vertical {
         get {
            return wxListbook_IsVertical(wxObject);
         }
      }
      ...
      public int PageCount {
         get {
            return wxListbook_GetPageCount(wxObject);
         }
      }
      ...
      public Size PageSize {
         set {
            wxListbook_SetPageSize(wxObject, ref value);
         }
      }
