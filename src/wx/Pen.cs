...
//
// $Id: Pen.cs,v 1.8 2004/11/14 14:53:29 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class Pen : GDIObject {
      ...
      public Colour Colour {
         get {
            return (Colour)FindObject(wxPen_GetColour(wxObject), typeof(Colour));
         }
         set {
      ...
      public int Width {
         get {
            return wxPen_GetWidth(wxObject);
         }
         set {
      ...
      public int Style {
         get {
            return wxPen_GetStyle(wxObject);
         }
         set {
            wxPen_SetStyle(wxObject, value);
         }
      }
