...
//
// $Id: ScrollBar.cs,v 1.6 2004/07/31 17:06:11 olkalex Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class ScrollBar : Control {
      ...
      public int ThumbPosition {
         get {
            return wxScrollBar_GetThumbPosition(wxObject);
         }
         set {
            wxScrollBar_SetThumbPosition(wxObject, value);
         }
      }
      ...
      public int ThumbSize {
         get {
            return wxScrollBar_GetThumbSize(wxObject);
         }
      }
      ...
      public int PageSize {
         get {
            return wxScrollBar_GetPageSize(wxObject);
         }
      }
      ...
      public int Range {
         get {
            return wxScrollBar_GetRange(wxObject);
         }
      }
      ...
      public bool IsVertical {
         get {
            return wxScrollBar_IsVertical(wxObject);
         }
      }
