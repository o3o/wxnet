...
//
// $Id: BitmapButton.cs,v 1.16 2005/05/19 22:15:01 nummish Exp $
//-----------------------------------------------------------------------------
...
namespace wx {
   public class BitmapButton : Control {
      ...
      public string StringLabel {
         ...
         set {
            wxBitmapButton_SetLabel(wxObject, value);
         }
      }
      ...
      public wx.Bitmap BitmapLabel {
         get {
            return (wx.Bitmap)FindObject(wxBitmapButton_GetBitmapLabel(wxObject), typeof(Bitmap));
         }
         set {
            wxBitmapButton_SetBitmapLabel(wxObject, Object.SafePtr(value));
         }
      }
      ...
      public Bitmap BitmapSelected {
         get {
            return (wx.Bitmap)FindObject(wxBitmapButton_GetBitmapSelected(wxObject), typeof(Bitmap));
         }
         set {
            wxBitmapButton_SetBitmapSelected(wxObject, Object.SafePtr(value));
         }
      }

      public Bitmap BitmapFocus {
         get {
            return (wx.Bitmap)FindObject(wxBitmapButton_GetBitmapFocus(wxObject), typeof(Bitmap));
         }
         set {
            wxBitmapButton_SetBitmapFocus(wxObject, Object.SafePtr(value));
         }
      }

      public Bitmap BitmapDisabled {
         get {
            return (wx.Bitmap)FindObject(wxBitmapButton_GetBitmapDisabled(wxObject), typeof(Bitmap));
         }
         set {
            wxBitmapButton_SetBitmapDisabled(wxObject, Object.SafePtr(value));
         }
      }
